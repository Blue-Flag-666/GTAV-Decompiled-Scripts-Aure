...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2FD0
{
	...
	bParam4;
	statName = Global_2805029[empsParam0 /*3*/][func_86(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x31FA
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0 /*3*/][func_86(iParam1)];
...
{
	iLocal_343 = 0;
	func_291(&func_293, &func_292, true);
	func_291(&func_289, &func_288, true);
	func_291(&func_287, &func_286, true);
	func_291(&func_285, &func_284, true);
	func_291(&func_283, &func_282, true);
	func_291(&func_280, &func_279, true);
	func_291(&func_276, &func_275, true);
	return;
}
