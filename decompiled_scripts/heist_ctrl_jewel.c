...
void func_153() // Position - 0x7153
{
	...
	if (func_231(18))
	{
		if (func_231(17))
		{
			...
			{
				if (!unk_0x1C2F771CDC87A3A5(uLocal_729, 0))
					unk_0xF293D66D4452C854(uLocal_729, "Lester", 0, joaat("CS_LesterCrest"), 0);
				else
					unk_0xF293D66D4452C854(uLocal_729, "Lester", 2, joaat("CS_LesterCrest"), 0);
			
				if (unk_0xFC8BFE4B41177C22(uLocal_732))
					if (unk_0x5B9219522937741D(uLocal_732))
						unk_0x837D67618BF89034(uLocal_732, 1, 1);
			
				if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
					unk_0xF293D66D4452C854(unk_0x4A8C381C258A124D(), "Michael", 0, joaat("Player_Zero"), 0);
			
				if (unk_0xFC8BFE4B41177C22(uLocal_732))
					unk_0xF293D66D4452C854(uLocal_732, "WalkingStick_Lester", 1, joaat("prop_cs_walking_stick"), 0);
				else
					unk_0xF293D66D4452C854(uLocal_732, "WalkingStick_Lester", 2, joaat("prop_cs_walking_stick"), 0);
		...
		else if (unk_0xFD216000DC314A92())
		{
			...
			{
				if (unk_0xFC8BFE4B41177C22(uLocal_732))
					unk_0x4285E11B28063EE0(uLocal_732, 1, 0);
			
				if (unk_0xFC8BFE4B41177C22(uLocal_730))
					unk_0x4285E11B28063EE0(uLocal_730, 1, 0);
			
				if (unk_0xFC8BFE4B41177C22(uLocal_729))
					unk_0x4285E11B28063EE0(uLocal_729, 1, 0);
			
				unk_0x8744D2E3FC95740E(&iLocal_41, 7);
			}
		
			if (unk_0xD8FC13DA1BA1DBA2("Lester", 0))
			{
				if (!unk_0x4FAFF4BCB7633475(uLocal_729))
				{
					args = uLocal_729;
		...
		else if (unk_0x1DD05E817C89C737() > iLocal_43 || _IS_MISSION_REPEAT_ACTIVE(false))
		{
			...
			unk_0x79CA429D8B4B057A(uLocal_46.f_1.f_394 - uLocal_46.f_1.f_397, uLocal_46.f_1.f_394 + uLocal_46.f_1.f_397, 1, 0);
...
void func_195(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x103D1
{
	...
	else
	{
		...
		if (unk_0x76CD105BCAC6EB9F())
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_200(unk_0x259BE71D8A81D4FA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x259BE71D8A81D4FA(), 0) && !func_196() && !bParam4 && !bParam5 && !unk_0xAD15761928FCF79C())
...
void func_204() // Position - 0x10673
{
	...
	if (func_231(16))
	{
		if (!_IS_MISSION_REPEAT_ACTIVE(false))
		{
			if (!IS_BIT_SET(iLocal_41, 10))
			{
				...
				func_212();
				func_115(0, 0, true);
				uLocal_733 = unk_0xA7B0B03284E7503C(uLocal_46.f_1.f_394 - uLocal_46.f_1.f_397, uLocal_46.f_1.f_394 + uLocal_46.f_1.f_397, 0, 1, 1, 1);
				iLocal_738 = unk_0x8CC50AC10D8037C7(uLocal_46.f_1.f_394, uLocal_46.f_1.f_397 * { 1.5f, 1.5f, 1.5f }, 0f, 0, 7);
				unk_0x89C4F1335B4A6633(uLocal_46.f_1.f_394 - uLocal_46.f_1.f_397, uLocal_46.f_1.f_394 + uLocal_46.f_1.f_397);
				unk_0x79CA429D8B4B057A(uLocal_46.f_1.f_394 - uLocal_46.f_1.f_397, uLocal_46.f_1.f_394 + uLocal_46.f_1.f_397, 0, 0);
			...
			if (IS_BIT_SET(iLocal_41, 2))
			{
				switch (iLocal_42)
				{
					case 0:
						...
						uLocal_734 = unk_0x96A32328480B485C(joaat("DEFAULT_SCRIPTED_CAMERA"), 724.4682f, -992.0684f, 24.251366f, 5.259225f, 0.000715f, 25.889177f, 44.13121f, 0, 2);
						uLocal_735 = unk_0x96A32328480B485C(joaat("DEFAULT_SCRIPTED_CAMERA"), 724.37274f, -991.3205f, 24.433039f, 31.499252f, 0.000715f, -4.206256f, 44.13121f, 0, 2);
						...
						if (unk_0xFC8BFE4B41177C22(Global_97178.f_9[0]))
						{
							if (!unk_0x1C2F771CDC87A3A5(Global_97178.f_9[0], 0))
							{
								...
								unk_0xEE0BCDB1B5E36BCB(uLocal_729, 0, 1);
							}
						}
					...
					case 1:
						...
						if (unk_0xFC8BFE4B41177C22(uLocal_731))
							if (unk_0xD9F5E1FEFD1329E4(uLocal_731, 0))
								unk_0xD6B4D02A102485DC(uLocal_734, uLocal_731, 0f, 0f, 0f, 1);
						...
						if (unk_0x1DD05E817C89C737() - iLocal_43 > 1200)
						{
							if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
							{
								if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
								{
									if (unk_0xD9F5E1FEFD1329E4(uLocal_731, 0))
									{
										if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), uLocal_731, 0))
										{
											unk_0xB5396F1FB088FE38(&uLocal_736);
											unk_0x23EB5FC236231892(0, uLocal_731, 0);
						...
						if (unk_0x1DD05E817C89C737() - iLocal_43 > 2400)
						{
							if (!unk_0x1C2F771CDC87A3A5(uLocal_729, 0))
							{
								if (unk_0xFC8BFE4B41177C22(uLocal_731))
								{
									if (unk_0xD9F5E1FEFD1329E4(uLocal_731, 0))
									{
										if (unk_0xCECDBB848D53DEB2(uLocal_729, uLocal_731, 0))
										{
											unk_0xB5396F1FB088FE38(&uLocal_737);
											unk_0x23EB5FC236231892(0, uLocal_731, 0);
											unk_0xA966E518B752B92A(0, 718.1777f, -976.126f, 23.9148f, 1f, 20000, 1048576000, 0, 1193033728);
											unk_0x93C0674FC00824D0(uLocal_737);
											unk_0x974022927CB47E68(uLocal_729);
											unk_0x4BD42B0527065BB6(uLocal_729, uLocal_737);
										}
									}
								}
							}
			...
			if (IS_BIT_SET(iLocal_41, 1) && !IS_BIT_SET(iLocal_41, 2))
			{
				if (unk_0xC4ADACBD3FE3F266("JH_1_MCS_4_P1_ALT1"))
				{
					if (!unk_0xFD216000DC314A92())
					{
						uLocal_730 = unk_0x4A8C381C258A124D();
					
						if (!unk_0x1C2F771CDC87A3A5(uLocal_730, 0))
							unk_0xF293D66D4452C854(uLocal_730, "Michael", 0, joaat("Player_Zero"), 0);
					
						if (!unk_0x1C2F771CDC87A3A5(uLocal_729, 0))
							unk_0xF293D66D4452C854(uLocal_729, "Lester", 2, joaat("IG_LesterCrest"), 0);
					...
					else
					{
						...
						if (!IS_BIT_SET(iLocal_41, 17))
						{
							...
							unk_0x0B0C9A0F9AAEB7F0(&iLocal_41, 17);
						}
						...
						if (!IS_BIT_SET(iLocal_41, 5))
						{
							...
							if (unk_0xFC8BFE4B41177C22(uLocal_729))
								unk_0x734A9F4537A31459(&uLocal_729);
						
							unk_0x0B0C9A0F9AAEB7F0(&iLocal_41, 5);
						}
						...
						if (IS_BIT_SET(iLocal_41, 8))
						{
							...
							{
								uLocal_732 = unk_0x0646D07BB2D516CD(unk_0x4240B5D04F91480C("WalkingStick_Lester", joaat("prop_cs_walking_stick")));
						...
						if (IS_BIT_SET(iLocal_41, 9))
						{
							...
							{
								uLocal_729 = unk_0xBD545F8729E9F413(unk_0x4240B5D04F91480C("Lester", joaat("IG_LesterCrest")));
						...
						if (unk_0xD8FC13DA1BA1DBA2("Michael", 0))
						{
							if (!unk_0x1C2F771CDC87A3A5(uLocal_730, 0))
							{
								unk_0xAAA71DD7E9059338(uLocal_730, 1);
								unk_0x0428AFDCAA63B06E(uLocal_730, 208, 1);
								unk_0x0428AFDCAA63B06E(uLocal_730, 118, 0);
								unk_0x0428AFDCAA63B06E(uLocal_730, 213, 0);
								unk_0x63C8DCBEC1CF8225(uLocal_730, 708.8129f, -966.3621f, 29.3956f, 1f, 20000, 1193033728, 1056964608);
							}
						}
						...
						if (unk_0xD8FC13DA1BA1DBA2("Lester", 0))
						{
							if (!unk_0x1C2F771CDC87A3A5(uLocal_729, 0))
								if (unk_0xFC8BFE4B41177C22(uLocal_732))
									unk_0x4D306DD94DD6FDBA(uLocal_732, uLocal_729, unk_0x72F7E39FB49FC0BA(uLocal_729, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
						
							if (!unk_0x1C2F771CDC87A3A5(uLocal_729, 0))
							{
								unk_0xAAA71DD7E9059338(uLocal_729, 1);
								unk_0x0428AFDCAA63B06E(uLocal_729, 208, 1);
								unk_0x0428AFDCAA63B06E(uLocal_729, 118, 0);
								unk_0x0428AFDCAA63B06E(uLocal_729, 213, 0);
								unk_0x63C8DCBEC1CF8225(uLocal_729, 708.3643f, -963.9194f, 29.4181f, 1f, 20000, 1193033728, 1056964608);
							}
						}
						...
						if (unk_0x2B60F53D06BC6971(0))
						{
							...
							if (!IS_BIT_SET(iLocal_41, 7))
							{
								...
								if (!unk_0x1C2F771CDC87A3A5(uLocal_729, 0))
									unk_0x4285E11B28063EE0(uLocal_729, 0, 0);
							
								if (unk_0xFC8BFE4B41177C22(uLocal_732))
									unk_0x4285E11B28063EE0(uLocal_732, 0, 0);
	...
	else
	{
		...
		if (IS_BIT_SET(iLocal_41, 10))
			unk_0x8744D2E3FC95740E(&iLocal_41, 10);
	}
...
void func_233(var uParam0, var uParam1) // Position - 0x11E50
{
	...
	func_241(uParam0, 750, 540, 2.1f, 1.47f, 3.6f, 2.05f, 2f, 375, 250, 116, 420, 248, 425, &func_1, 425, 510, 430, 0, 0, 650, 300, 0, 70, 684, 106);
