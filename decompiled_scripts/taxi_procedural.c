...
void func_76(int iParam0) // Position - 0x2B65
{
	...
	if (iParam0 == 14)
	{
		_MPCHAR_STAT_SET_INT(&func_64, 0, -1, true, false);
		return;
	}
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2DF5
{
	...
	bParam4;
	statName = Global_2805029[empsParam0 /*3*/][func_80(iParam2)];
...
BOOL func_82(int iParam0) // Position - 0x2E79
{
	...
	if (iParam0 == 14)
	{
		...
		num3 = _MPCHAR_STAT_GET_INT(&func_64, -1, 0);
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x301F
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0 /*3*/][func_80(iParam1)];
...
{
	iLocal_343 = 0;
	func_413(&func_415, &func_414, true);
	func_413(&func_411, &func_410, true);
	func_413(&func_409, &func_408, true);
	func_413(&func_407, &func_406, true);
	func_413(&func_405, &func_404, true);
	func_413(&func_403, &func_402, true);
	func_413(&func_399, &func_398, true);
	return;
}
