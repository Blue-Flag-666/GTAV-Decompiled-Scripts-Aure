...
void main() // Position - 0x0
{
	...
	uLocal_54 = unk_0x8CC13B3BF7A9890A();
	uLocal_55 = unk_0x2A3612A4B836469E();
	iLocal_268 = -1;
	fLocal_270 = 1f;
	iLocal_383 = 100;
	iLocal_384 = 3;
	...
	iLocal_1049 = unk_0x4A8C381C258A124D();
	...
	unk_0xA1F44380A2D59F2B(iLocal_1331, 1);
	unk_0xA1F44380A2D59F2B(iLocal_1332, 1);
	...
	while (true)
	{
		...
		else if (!unk_0x4FAFF4BCB7633475(iLocal_1049))
		{
			func_457();
			...
			if (bLocal_1138 || bLocal_1143 && iLocal_1035 < 11 || bLocal_1173 && iLocal_1035 < 11)
			{
				...
				else if (func_52(&uLocal_1358) > 2.5f)
				{
					if (!bLocal_1174)
					{
						...
						{
							if (!unk_0x4FAFF4BCB7633475(iLocal_1061))
							{
								unk_0x974022927CB47E68(iLocal_1061);
							
								if (iLocal_1048 == 1)
								{
									if (unk_0xFC8BFE4B41177C22(uLocal_1318))
										if (!unk_0x7F420695E3F776FB(iLocal_1061, 0))
											unk_0x2433FB137DF847D2(iLocal_1061, uLocal_1318, uLocal_1318, 2f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
								
									if (unk_0xFC8BFE4B41177C22(iLocal_1061) && !unk_0x4FAFF4BCB7633475(iLocal_1061))
									{
								...
								{
									if (unk_0xFC8BFE4B41177C22(iLocal_1316) && unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
										unk_0x2433FB137DF847D2(iLocal_1061, iLocal_1316, iLocal_1316, 2f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
								...
								{
									unk_0x646DE293036A3499(iLocal_1061, unk_0x4A8C381C258A124D(), -1, 0);
									func_2(iLocal_1061);
								}
							}
						}
...
void func_1() // Position - 0x723
{
	...
	if (unk_0x7F420695E3F776FB(iLocal_1049, 0))
	{
		unk = unk_0x6EF03BE64E058E2F(iLocal_1049, 0);
	...
	if (bLocal_1148)
		if (unk_0x4A64AADF9B40D2AF(unk, iLocal_1316))
			unk_0xD4BC322888F79B7E(unk, iLocal_1316);
...
int func_31(float fParam0) // Position - 0x1212
{
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_1054[i]))
	...
	for (i = 0; i <= 1; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_1058[i]))
...
int func_36(int iParam0, BOOL bParam1) // Position - 0x13D9
{
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_1054[i]))
		{
			if (bParam1 || !bParam1 && !unk_0x7F420695E3F776FB(uLocal_1054[i], 0))
			{
	...
	for (i = 0; i <= 1; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_1058[i]))
		{
			if (bParam1 || !bParam1 && !unk_0x7F420695E3F776FB(uLocal_1058[i], 0))
			{
	...
	for (i = 0; i <= 1; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_1051[i]))
		{
			if (bParam1 || !bParam1 && !unk_0x7F420695E3F776FB(uLocal_1058[i], 0))
			{
...
BOOL func_60(var uParam0) // Position - 0x2644
{
	...
	if (iLocal_1035 > 11)
	{
		if (!unk_0x4FAFF4BCB7633475(iLocal_1050))
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
				if (unk_0xCECDBB848D53DEB2(iLocal_1050, iLocal_1316, 0))
					flag = true;
		...
		if (unk_0xFC8BFE4B41177C22(iLocal_1050))
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_1050))
			{
				if (func_30(iLocal_1049, iLocal_1050, 1) >= num)
				{
					if (flag)
					{
						if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
						{
							if (unk_0xF6C26AE940C14749(iLocal_1316) || !unk_0xCB5CAFF0A4A8B74B(iLocal_1316))
							{
								*uParam0 = 6;
								return true;
							}
					...
					else if (unk_0xF6C26AE940C14749(iLocal_1050))
					{
						*uParam0 = 6;
						return true;
					}
				}
				else if (unk_0xC450B06E5AAA0985(iLocal_1124))
				{
					if (func_30(iLocal_1049, iLocal_1050, 1) >= num * 0.5f)
						if (!unk_0x4B889DE2DAC956DB(iLocal_1124))
							unk_0x861AC9C2D48CEA7F(iLocal_1124, 1);
					else if (unk_0x4B889DE2DAC956DB(iLocal_1124))
						unk_0x861AC9C2D48CEA7F(iLocal_1124, 0);
				}
			}
		}
	}
...
void func_97() // Position - 0x3BF9
{
	...
	switch (iLocal_1211)
	{
		case 0:
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (!unk_0x1C2F771CDC87A3A5(uLocal_1054[0], 0))
					unk_0x84B06A81C98DA4B8(uLocal_1054[0]);
			
				if (!unk_0x1C2F771CDC87A3A5(uLocal_1054[1], 0))
					unk_0x84B06A81C98DA4B8(uLocal_1054[1]);
				...
				else if (!bLocal_1168 && unk_0x4FAFF4BCB7633475(iLocal_1050))
				{
					if (!bLocal_1177)
					{
						func_34(num, 3, "OJAvaGUARD");
		...
		case 2:
			if (bLocal_1177 || !unk_0x4FAFF4BCB7633475(iLocal_1050))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !bLocal_1161)
				{
					...
					else if (!bLocal_1185 && unk_0x4FAFF4BCB7633475(iLocal_1050))
					{
						num = func_101();
						func_100(num);
					}
			...
			if (func_58(&uLocal_1343))
			{
				if (func_52(&uLocal_1343) > fLocal_1248 && func_98() || unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
				{
					func_3();
...
BOOL func_98() // Position - 0x3E43
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1054[i]) && !unk_0x1C2F771CDC87A3A5(uLocal_1054[i], 0))
		{
			unk_0x0FB8E752BCC547A9(uLocal_1054[i], 85, 1);
		
			if (unk_0x7E54CB377175F94E(uLocal_1054[i], unk_0x4A8C381C258A124D()))
				return true;
		}
	}
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1058[i]) && !unk_0x1C2F771CDC87A3A5(uLocal_1058[i], 0))
		{
			unk_0x0FB8E752BCC547A9(uLocal_1058[i], 85, 1);
		
			if (unk_0x7E54CB377175F94E(uLocal_1058[i], unk_0x4A8C381C258A124D()))
				return true;
		}
	}
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1051[i]) && !unk_0x1C2F771CDC87A3A5(uLocal_1051[i], 0))
		{
			unk_0x0FB8E752BCC547A9(uLocal_1051[i], 85, 1);
		
			if (unk_0x7E54CB377175F94E(uLocal_1051[i], unk_0x4A8C381C258A124D()))
				return true;
		}
	}
...
void func_100(int iParam0) // Position - 0x3FC6
{
	if (!bLocal_1185)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_1050) && unk_0x4FAFF4BCB7633475(iLocal_1050))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
...
int func_101() // Position - 0x403F
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1054[i]) && !unk_0x4FAFF4BCB7633475(uLocal_1054[i]))
			num = uLocal_1054[i];
	}
	...
	if (num == 0)
	{
		for (i = 0; i < 2; i = i + 1)
		{
			if (unk_0xFC8BFE4B41177C22(uLocal_1058[i]) && !unk_0x4FAFF4BCB7633475(uLocal_1058[i]))
				num = uLocal_1058[i];
		}
	}
	...
	if (num == 0)
	{
		for (i = 0; i < 2; i = i + 1)
		{
			if (unk_0xFC8BFE4B41177C22(uLocal_1051[i]) && !unk_0x4FAFF4BCB7633475(uLocal_1051[i]))
				num = uLocal_1051[i];
		}
	}
...
BOOL func_103(var uParam0) // Position - 0x412B
{
	...
	if (!bLocal_1138)
	{
		...
		if (unk_0x11552FA9DCB8E126(iLocal_1049, 4))
		{
			if (unk_0x65F146FF416F109F(iLocal_1049))
			{
				num = func_32(unk_0x4A8C381C258A124D(), -1230.5994f, -196.5408f, 38.1528f, 1);
				unk_0x23B29877D0BE9547(iLocal_1049, &num2, 1);
		...
		if (func_107(iLocal_1316) || func_106(iLocal_1316) || unk_0xFC8BFE4B41177C22(iLocal_1316) && unk_0x9B3D4335E0EDB0BE(iLocal_1316, iLocal_1049, 1))
			return true;
	
		if (func_107(iLocal_1317) || unk_0xFC8BFE4B41177C22(iLocal_1317) && unk_0x9B3D4335E0EDB0BE(iLocal_1317, iLocal_1049, 1))
			return true;
	
		if (unk_0xFC8BFE4B41177C22(iLocal_1316) && !unk_0x1C2F771CDC87A3A5(iLocal_1316, 0))
		{
			if (unk_0xCECDBB848D53DEB2(iLocal_1049, iLocal_1316, 0))
			{
				unk_0xD45558BDBDE86734(iLocal_1316, 1);
				unk_0x495F6DB2481DBAEE(iLocal_1316);
				return true;
			}
		}
	
		if (unk_0xFC8BFE4B41177C22(iLocal_1316))
		{
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
			{
				if (unk_0x7F420695E3F776FB(iLocal_1049, 0))
				{
					...
					if (unk_0x685171EED42BC4DF(unk, iLocal_1316) || bLocal_1148 && unk_0x4A64AADF9B40D2AF(unk, iLocal_1316))
					{
						*uParam0 = 4;
						return true;
					}
		...
		if (iLocal_1035 < 11)
			if (unk_0x8764A5B95AE1F967(-1, uLocal_1312, fLocal_1315))
				return true;
		else if (unk_0x8764A5B95AE1F967(-1, uLocal_1312, fLocal_1315))
			if (func_104())
				bLocal_1192 = true;
			else
				return true;
...
BOOL func_106(int iParam0) // Position - 0x4460
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		if (unk_0xD9F5E1FEFD1329E4(iParam0, 0))
			if (unk_0x38A100E16C95161B(iParam0) == 3 && unk_0x31945A289F1359A1(iLocal_1049) == iParam0)
				return 1;
...
BOOL func_108(var uParam0) // Position - 0x4568
{
	if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
	{
		if (unk_0x43F53DDC37E17FE9(unk_0x4A8C381C258A124D(), iLocal_1316, joaat("WEAPON_STICKYBOMB"), -1))
		{
...
void func_109() // Position - 0x45FC
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1054[i]))
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1058[i]))
			if (bLocal_1138 && !bLocal_1171)
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1051[i]))
		{
			if (bLocal_1138 && !bLocal_1171)
			...
			if (!unk_0x4FAFF4BCB7633475(uLocal_1051[i]))
				if (uLocal_1045[i] == 4)
					unk_0x0FB8E752BCC547A9(uLocal_1051[i], 128, 1);
		}
	}
	...
	if (bLocal_1138)
		if (!unk_0x1C2F771CDC87A3A5(iLocal_1050, 0))
			unk_0x0FB8E752BCC547A9(iLocal_1050, 120, 1);
...
void func_110(int iParam0) // Position - 0x4839
{
	...
	switch (uLocal_1041[iParam0])
	{
		...
		case 1:
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1317, 0))
			{
				if (func_134())
				{
					if (!unk_0x8DC9348C726B1575(iLocal_1317))
						if (unk_0xFD5C5BBD1FE92BB7(iLocal_1317, -1, 0) == uLocal_1058[iParam0])
							unk_0x43E9B2BD3668B432(uLocal_1058[iParam0], iLocal_1317, "OJASva_104", 948, 0, 16, 18, 6f, 0, 1073741824);
		...
		case 2:
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1317, 0))
			{
				if (!unk_0x8DC9348C726B1575(iLocal_1317))
				{
					unk = { unk_0xD1A6A821F5AC81DB(iLocal_1317, 1) };
					unk4 = unk_0xCFC0C995455A6204(iLocal_1317);
					bLocal_1151 = false;
		...
		case 3:
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1317, 0))
			{
				if (!unk_0x1C2F771CDC87A3A5(uLocal_1058[iParam0], 0))
				{
					if (unk_0xCECDBB848D53DEB2(uLocal_1058[iParam0], iLocal_1317, 0) && unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
					{
						if (!bLocal_1138)
						{
							if (unk_0xFD5C5BBD1FE92BB7(iLocal_1317, -1, 0) == uLocal_1058[iParam0])
								if (unk_0x9B5C1660CCDF7189(uLocal_1058[iParam0], joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1)
									unk_0x6AA87C4ADF4A6BFF(uLocal_1058[iParam0], iLocal_1317, iLocal_1316, -1, 45f, 786981, 10f, -1, 10f);
						}
						else if (unk_0xFD5C5BBD1FE92BB7(iLocal_1317, -1, 0) == uLocal_1058[iParam0])
						{
							if (!bLocal_1152)
							{
								if (unk_0x1C2F771CDC87A3A5(iLocal_1050, 0))
						...
						{
							if (unk_0x9B5C1660CCDF7189(uLocal_1058[iParam0], joaat("SCRIPT_TASK_COMBAT")) != 1)
							{
								if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
									if (unk_0xDF93B3CFAC96698F(iLocal_1317) < 5f)
										uLocal_1041[iParam0] = 8;
							
								unk_0x62A5310368A20EFA(num, unk_0x4A8C381C258A124D(), 0, 16);
							}
						}
						else if (unk_0x9B5C1660CCDF7189(uLocal_1058[iParam0], joaat("SCRIPT_TASK_COMBAT")) != 1)
						{
							unk_0x62A5310368A20EFA(num, unk_0x4A8C381C258A124D(), 0, 16);
						}
					}
		...
		case 5:
			if (!func_99(iLocal_1049))
				if (func_52(&uLocal_1337) >= 27f || unk_0x3EE1A6D743332852(unk_0x259BE71D8A81D4FA(), 0))
					if (!unk_0x4FAFF4BCB7633475(num))
						if (unk_0xFAA48325A90263BE(iLocal_1049, num, 5f, 5f, 3f, 0, 1, 0))
		...
		case 6:
			if (bLocal_1163)
			{
				unk_0xB5396F1FB088FE38(&uLocal_1328);
				...
				unk_0x93C0674FC00824D0(uLocal_1328);
			
				if (!unk_0x4FAFF4BCB7633475(uLocal_1058[iParam0]))
					unk_0x4BD42B0527065BB6(uLocal_1058[iParam0], uLocal_1328);
			
				unk_0xD0557B139A542F12(&uLocal_1328);
			}
			else
			{
				unk_0xB5396F1FB088FE38(&uLocal_1328);
		...
		case 7:
			if (!unk_0x4FAFF4BCB7633475(uLocal_1058[iParam0]))
				if (unk_0x9B5C1660CCDF7189(uLocal_1058[iParam0], joaat("SCRIPT_TASK_ANY")) != 1)
					unk_0x2433FB137DF847D2(uLocal_1058[iParam0], iLocal_1049, iLocal_1049, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
			break;
	...
	{
		if (unk_0xCECDBB848D53DEB2(num, iLocal_1317, 0))
			if (!unk_0xD9F5E1FEFD1329E4(iLocal_1317, 0) || !unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0) || bLocal_1150 || !bLocal_1141)
...
BOOL func_114(int iParam0, float fParam1) // Position - 0x4F3F
{
	if (!bLocal_1138)
		if (!func_99(iLocal_1049))
			if (unk_0xFC8BFE4B41177C22(iParam0))
				if (!unk_0x4FAFF4BCB7633475(iParam0))
					if (func_29(iParam0, 0) <= fParam1)
						if (unk_0x3644984C9D7B57EF(iParam0, iLocal_1049, 120f))
							if (unk_0xAD915B5E38F323E5(iParam0, iLocal_1049, 17))
			...
			if (!unk_0x4FAFF4BCB7633475(iParam0))
				if (unk_0xFAA48325A90263BE(iLocal_1049, iParam0, 5f, 5f, 1f, 0, 1, 0))
					if (unk_0x3644984C9D7B57EF(iParam0, iLocal_1049, 120f))
						if (unk_0xAD915B5E38F323E5(iParam0, iLocal_1049, 17))
							return true;
...
void func_116(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x5070
{
	...
	if (unk_0x1C2F771CDC87A3A5(iLocal_1316, 0) || bLocal_1192)
		bLocal_1161 = 1;

	if (unk_0xFC8BFE4B41177C22(iLocal_1050))
	{
		if (unk_0x1AC621DBDFE4ECA0(iLocal_1050, joaat("WEAPON_SNIPERRIFLE"), 0) || unk_0x1AC621DBDFE4ECA0(iLocal_1050, joaat("WEAPON_HEAVYSNIPER"), 0) || unk_0x1AC621DBDFE4ECA0(iLocal_1050, joaat("WEAPON_REMOTESNIPER"), 0) || unk_0x1AC621DBDFE4ECA0(iLocal_1050, joaat("WEAPON_MARKSMANRIFLE"), 0))
		{
			bLocal_1160 = true;
			iLocal_1036 = 1;
		}
	...
	{
		if (!unk_0x8DC9348C726B1575(iLocal_1316))
		{
			iParam3 = iParam3 * 2f;
			flag = true;
		}
...
BOOL func_119(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5323
{
	...
	if (bParam3)
	{
		if (!bLocal_356)
		{
			iLocal_357 = unk_0x8D91ADE44AC79BC9(uParam0);
			bLocal_356 = true;
		}
	
		uLocal_358 = unk_0x8D91ADE44AC79BC9(uParam0);
				...
				if (func_30(iParam1, iParam0, 0) > iParam2 && func_29(iParam1, 1) < iParam3)
				{
					if (!unk_0xCECDBB848D53DEB2(iParam1, iParam0, 0))
					{
						if (unk_0x9B5C1660CCDF7189(iParam1, joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 1)
							unk_0xEBA229B2E0BB05E0(iParam1, iParam0, 20000, -1, 1073741824, 1, 0);
					}
...
void func_126(int iParam0) // Position - 0x590C
{
	...
	if (!unk_0x4FAFF4BCB7633475(iLocal_1049) && !unk_0x4FAFF4BCB7633475(iParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(iParam0, 0))
		...
		unk_0x646DE293036A3499(0, iLocal_1049, -1, 0);
...
{
	if (!unk_0x1C2F771CDC87A3A5(iLocal_1049, 0))
	{
		if (!unk_0x7F420695E3F776FB(iLocal_1049, 0))
		{
			if (!unk_0x1C2F771CDC87A3A5(iParam0, 0))
			...
			unk_0xB5396F1FB088FE38(&uLocal_1328);
			unk_0x092B9247AF00F5CF(0, 0, 256);
			unk_0x62A5310368A20EFA(0, iLocal_1049, 0, 16);
			unk_0x93C0674FC00824D0(uLocal_1328);
		
			if (!unk_0x1C2F771CDC87A3A5(iParam0, 0))
				unk_0x4BD42B0527065BB6(iParam0, uLocal_1328);
		...
		else if (!unk_0x4FAFF4BCB7633475(iParam0))
		{
			if (unk_0x9B5C1660CCDF7189(iParam0, joaat("SCRIPT_TASK_COMBAT")) != 1)
			{
				...
				unk_0x62A5310368A20EFA(iParam0, iLocal_1049, 0, 16);
			}
		}
	}
...
void func_129(int iParam0, float fParam1, float fParam2, float fParam3) // Position - 0x5A8A
{
	if (!bLocal_1138)
	{
		if (!unk_0x4FAFF4BCB7633475(iParam0))
		{
			if (unk_0xFAA48325A90263BE(iLocal_1049, iParam0, fParam1, 0, 1, 0))
			{
				if (unk_0x3644984C9D7B57EF(iParam0, iLocal_1049, 160f))
				{
					if (unk_0xAD915B5E38F323E5(iParam0, iLocal_1049, 17))
					{
						unk_0x2433FB137DF847D2(iParam0, iLocal_1049, iLocal_1049, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						iLocal_1048 = 5;
						bLocal_1138 = true;
					}
				}
		...
		if (!unk_0x7F420695E3F776FB(*uParam0, 0))
		{
			if (!bLocal_1140)
			{
				if (*uParam0 == iLocal_1061)
				{
					unk_0xD0557B139A542F12(&unk);
					unk_0xB5396F1FB088FE38(&unk);
					unk_0xAB3658A740EED98E(0, iLocal_1049, 20000, 2f, 1f, 1073741824, 0);
					unk_0x0E95B96CFEFE7B61(0, iLocal_1049, -1);
					unk_0x93C0674FC00824D0(unk);
				...
				{
					unk_0x0E95B96CFEFE7B61(*uParam0, iLocal_1049, -1);
				}
			}
...
BOOL func_132() // Position - 0x5C88
{
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		...
		if (!unk_0x1C2F771CDC87A3A5(iLocal_1316, 0))
			vector2 = { unk_0xD1A6A821F5AC81DB(iLocal_1316, 1) };
...
void func_133(int iParam0) // Position - 0x5CDF
{
	...
	if (!unk_0x1C2F771CDC87A3A5(uLocal_1058[iParam0], 0))
		if (unk_0xD9F5E1FEFD1329E4(iLocal_1317, 0))
			if (!unk_0xCECDBB848D53DEB2(uLocal_1058[iParam0], iLocal_1317, 0))
				if (unk_0x9B5C1660CCDF7189(uLocal_1058[iParam0], joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 1)
					unk_0xEBA229B2E0BB05E0(uLocal_1058[iParam0], iLocal_1317, 20000, num, 1073741824, 1, 0);
...
{
	if (!unk_0x4FAFF4BCB7633475(uLocal_1058[0]) && !unk_0x4FAFF4BCB7633475(uLocal_1058[1]))
		if (unk_0xCECDBB848D53DEB2(uLocal_1058[0], iLocal_1317, 0) && unk_0xCECDBB848D53DEB2(uLocal_1058[1], iLocal_1317, 0))
			return true;
	...
	switch (uLocal_1037[iParam0])
	{
		case 0:
			if (!unk_0x4FAFF4BCB7633475(num))
			{
				unk_0xD0557B139A542F12(&uLocal_1328);
				unk_0xB5396F1FB088FE38(&uLocal_1328);
				unk_0x30FAA55EAF29F9BE(0, uLocal_1272[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
				unk_0x2280392018BC0DD3(0, uLocal_1225[iParam0], 0);
				unk_0x93C0674FC00824D0(uLocal_1328);
				unk_0x4BD42B0527065BB6(num, uLocal_1328);
				unk_0xD0557B139A542F12(&uLocal_1328);
				...
				if (!unk_0x1C2F771CDC87A3A5(num, 0))
					if (!bLocal_1173)
						if (unk_0x9B5C1660CCDF7189(num, joaat("SCRIPT_TASK_PLAY_ANIM")) != 1 && unk_0x9B5C1660CCDF7189(num, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1)
							if (unk_0x65FFA94B82A71741(num, uLocal_1272[iParam0 /*3*/], 3f, 3f, 3f, 0, 1, 0))
		...
		case 3:
			...
			else if (func_52(&uLocal_1337) > uLocal_1231[iParam0] || unk_0x3EE1A6D743332852(unk_0x259BE71D8A81D4FA(), 0))
			{
				func_130(&num);
				uLocal_1037[iParam0] = 2;
			}
		...
		case 4:
			...
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
			{
				if (!unk_0x4FAFF4BCB7633475(num))
				{
					if (iParam0 == 0)
					{
						unk_0xE67051907958B5EB(uLocal_1054[0], uLocal_1054[1], -1, 0, 2);
					
						if (!unk_0xCECDBB848D53DEB2(num, iLocal_1316, 0))
							unk_0xEBA229B2E0BB05E0(num, iLocal_1316, 30000, -1, 1f, 1, 0);
					}
					else if (iParam0 == 1)
					{
						unk_0xE67051907958B5EB(uLocal_1054[1], uLocal_1054[0], -1, 0, 2);
					
						if (!unk_0xCECDBB848D53DEB2(num, iLocal_1316, 0))
							unk_0xEBA229B2E0BB05E0(num, iLocal_1316, 30000, 0, 1f, 1, 0);
					}
					else if (iParam0 == 2)
					{
						if (unk_0xD9F5E1FEFD1329E4(iLocal_1317, 0))
							if (!unk_0xCECDBB848D53DEB2(num, iLocal_1317, 0))
								unk_0xEBA229B2E0BB05E0(num, iLocal_1317, 30000, 1, 1f, 1, 0);
					}
				}
		...
		case 5:
			...
			if (!unk_0x1C2F771CDC87A3A5(num, 0))
				if (unk_0x9B5C1660CCDF7189(num, joaat("SCRIPT_TASK_LOOK_AT_ENTITY")) != 1)
					if (iParam0 == 0)
						unk_0xE67051907958B5EB(uLocal_1054[iParam0], uLocal_1054[1], -1, 2048, 4);
					else if (iParam0 == 1)
						unk_0xE67051907958B5EB(uLocal_1054[iParam0], uLocal_1054[0], -1, 2048, 4);
					...
					if (bLocal_1138)
					{
						if (!unk_0x4FAFF4BCB7633475(num))
						{
							if (unk_0x9B5C1660CCDF7189(num, joaat("SCRIPT_TASK_COMBAT")) != 1)
							{
								...
								unk_0x62A5310368A20EFA(num, iLocal_1049, 0, 16);
							}
						}
					}
				}
		...
		case 6:
			if (!bLocal_1138)
			{
				if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
				{
					if (unk_0xFD5C5BBD1FE92BB7(iLocal_1316, -1, 0) == num)
					{
						if (!unk_0x4FAFF4BCB7633475(num))
						{
							unk_0xC229299217554C78(iLocal_1316, 1, 1, 0);
						
							if (func_138())
								unk_0x43E9B2BD3668B432(num, iLocal_1316, "OJASva_101a", 181, 0, 16, -1, 10f, 0, 1073741824);
							else
								unk_0x43E9B2BD3668B432(num, iLocal_1316, "OJASva_101", 181, 0, 0, -1, -1082130432, 0, 1073741824);
						}
					}
		...
		case 7:
			if (bLocal_1138)
			{
				if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0) && unk_0xFD5C5BBD1FE92BB7(iLocal_1316, -1, 0) == num && unk_0xFD5C5BBD1FE92BB7(iLocal_1316, 1, 0) == iLocal_1050)
				{
					if (!unk_0x4FAFF4BCB7633475(num))
					{
						if (bLocal_1153 || bLocal_1167 && !unk_0x8DC9348C726B1575(iLocal_1316))
						{
							...
							if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
								if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
									if (unk_0x9B5C1660CCDF7189(num, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1)
										unk_0xB3DA477F44309390(num, iLocal_1316, unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 8, 35f, 786469, -1f, -1f, 1);
								else if (unk_0x9B5C1660CCDF7189(num, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1)
									unk_0x13DE13EA38996410(num, iLocal_1316, unk_0x4A8C381C258A124D(), 8, 35f, 786469, -1f, -1f, 1);
						}
					}
				}
				else if (!unk_0x4FAFF4BCB7633475(num))
			...
			else if (bLocal_1153 || bLocal_1167 && !unk_0x8DC9348C726B1575(iLocal_1316))
			{
				if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
					if (unk_0xFD5C5BBD1FE92BB7(iLocal_1316, -1, 0) == num)
						if (!unk_0x1C2F771CDC87A3A5(num, 0))
							if (unk_0x9B5C1660CCDF7189(num, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1)
								unk_0x30CCF17FEE4BDA53(num, iLocal_1316, uLocal_1294, 8, 25f, 786603, -1f, -1f, 1);
			}
			break;
		...
		case 8:
			if (bLocal_1163)
			{
				...
				if (!unk_0x1C2F771CDC87A3A5(uLocal_1054[iParam0], 0))
					unk_0x4BD42B0527065BB6(uLocal_1054[iParam0], uLocal_1328);
		...
		case 9:
			if (!unk_0x4FAFF4BCB7633475(uLocal_1054[iParam0]))
				if (unk_0x9B5C1660CCDF7189(uLocal_1054[iParam0], joaat("SCRIPT_TASK_ANY")) != 1)
					unk_0x2433FB137DF847D2(uLocal_1054[iParam0], iLocal_1049, iLocal_1049, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
			break;
...
BOOL func_137(int iParam0) // Position - 0x6711
{
	...
	if (!bLocal_1138)
	{
		if (unk_0xFC8BFE4B41177C22(iParam0))
		{
			...
			if (func_118(iParam0, num, &uLocal_360, &iLocal_371, false, false, false, 1, true) || unk_0x8BF5256C439DF778(iParam0) && func_29(iParam0, 1) < 1.5f)
				return true;
		}
	}
...
BOOL func_138() // Position - 0x6785
{
	...
	num = 10;
	uLocal_1216 = unk_0xD65B4E942A960E26(unk_0x4A8C381C258A124D(), &num);
...
BOOL func_140() // Position - 0x684B
{
	if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
		if (!unk_0x4FAFF4BCB7633475(iLocal_1050))
			if (!bLocal_1138)
				if (unk_0xCECDBB848D53DEB2(iLocal_1050, iLocal_1316, 0) && func_141())
					return true;
			else if (unk_0xCECDBB848D53DEB2(iLocal_1050, iLocal_1316, 0))
				return true;
...
int func_141() // Position - 0x68A1
{
	...
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_1051[i]))
			if (!unk_0x7F420695E3F776FB(uLocal_1051[i], 0))
				num = 0;
	}
	...
	if (!unk_0x4FAFF4BCB7633475(iParam0))
		if (func_29(iParam0, 1) < 5f)
			if (unk_0x9B5C1660CCDF7189(iParam0, joaat("SCRIPT_TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY")) != 1 && unk_0x9B5C1660CCDF7189(iParam0, joaat("SCRIPT_TASK_AIM_GUN_AT_ENTITY")) != 1)
				unk_0x646DE293036A3499(iParam0, iLocal_1049, -1, 0);
...
void func_147(int iParam0) // Position - 0x6B2F
{
	...
	if (!unk_0xFC8BFE4B41177C22(uLocal_1051[iParam0]))
		return;
	...
	switch (uLocal_1045[iParam0])
	{
		case 0:
			if (!unk_0x1C2F771CDC87A3A5(iLocal_1050, 0))
			{
				if (!unk_0x7F420695E3F776FB(iLocal_1050, 0))
				{
					if (!unk_0x4FAFF4BCB7633475(uLocal_1051[iParam0]))
					{
						if (iParam0 == 0)
						{
							unk_0x329B82704ED2A3E3(uLocal_1051[iParam0], iLocal_1050, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
						}
						else if (iParam0 == 1)
						{
							if (unk_0xD9F5E1FEFD1329E4(iLocal_1317, 0))
							{
								...
								unk_0xEBA229B2E0BB05E0(0, iLocal_1317, 30000, 2, 1f, 1, 0);
								unk_0x93C0674FC00824D0(unk);
								unk_0x4BD42B0527065BB6(uLocal_1051[iParam0], unk);
								unk_0xD0557B139A542F12(&unk);
							}
						}
		...
		case 1:
			...
			if (!unk_0x1C2F771CDC87A3A5(uLocal_1051[iParam0], 0))
				if (unk_0xD9F5E1FEFD1329E4(num, 0))
					if (!unk_0x1C2F771CDC87A3A5(uLocal_1051[iParam0], 0))
						if (!unk_0xCECDBB848D53DEB2(uLocal_1051[iParam0], num, 0))
							if (unk_0x7F420695E3F776FB(iLocal_1050, 0))
								if (unk_0x9B5C1660CCDF7189(uLocal_1051[iParam0], joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 1)
									unk_0xEBA229B2E0BB05E0(uLocal_1051[iParam0], num, 30000, num2, 1f, 1, 0);
						else
		...
		case 2:
			...
			if (unk_0xD9F5E1FEFD1329E4(num, 0))
			{
				if (!unk_0x1C2F771CDC87A3A5(uLocal_1051[iParam0], 0))
				{
					if (unk_0xCECDBB848D53DEB2(uLocal_1051[iParam0], num, 0) && unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
					{
						if (bLocal_1138)
						{
							if (!bLocal_1168)
							{
								if (unk_0x9B5C1660CCDF7189(uLocal_1051[iParam0], joaat("SCRIPT_TASK_COMBAT")) != 1)
								{
									if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
										if (unk_0xDF93B3CFAC96698F(num) < 5f)
											uLocal_1045[iParam0] = 5;
								
									unk_0x62A5310368A20EFA(uLocal_1051[iParam0], unk_0x4A8C381C258A124D(), 0, 16);
								}
							}
							else if (unk_0x9B5C1660CCDF7189(uLocal_1051[iParam0], joaat("SCRIPT_TASK_COMBAT")) != 1)
							{
								unk_0x62A5310368A20EFA(uLocal_1051[iParam0], unk_0x4A8C381C258A124D(), 0, 16);
							}
						}
		...
		case 3:
			if (!unk_0x4FAFF4BCB7633475(uLocal_1051[iParam0]))
				if (unk_0x5110BDFA9CB51F2B(uLocal_1051[iParam0]))
					unk_0x895CE77855F9AFD2(uLocal_1051[iParam0]);
			...
			if (bLocal_1163)
			{
				...
				unk_0x2868A36BD27FD939(0, unk_0x4A8C381C258A124D(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				unk_0x93C0674FC00824D0(uLocal_1328);
				unk_0x4BD42B0527065BB6(uLocal_1051[iParam0], uLocal_1328);
				unk_0xD0557B139A542F12(&uLocal_1328);
			}
			else if (!unk_0x4FAFF4BCB7633475(uLocal_1051[iParam0]))
			{
				unk_0xBB4D4E549F8E6E8C(uLocal_1051[iParam0], uLocal_1309, 15f, 0, 0);
				unk_0xD0764B65C2DFEDCA(uLocal_1051[iParam0], 1);
				unk_0xBE8796DB2B90A437(uLocal_1051[iParam0], 0, 1);
				unk_0x4190C67D524CD0DC(uLocal_1051[iParam0], 2f);
			
				if (!bLocal_1135 && !unk_0x7F420695E3F776FB(uLocal_1051[iParam0], 0))
				{
					unk_0xB5396F1FB088FE38(&uLocal_1328);
					...
					else
					{
						...
						unk_0x329B82704ED2A3E3(0, iLocal_1050, 1.5f, 0f, 0f, 2f, -1, 1036831949, 1);
					}
				...
				else
				{
					if (unk_0xFC8BFE4B41177C22(iLocal_1316) && unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
					{
						unk2 = { unk_0x75DF72FC74EED046(iLocal_1316, unk_0x365DC1E8054AF31A(iLocal_1316, "wheel_lr")) };
						unk5 = { unk_0xD1A6A821F5AC81DB(iLocal_1316, 1) };
						unk5 = { unk2 - unk5 };
						unk_0x06AA75009161058B(uLocal_1051[iParam0], iLocal_1316, unk5, 1.5f, 0);
					}
				
					unk_0xB5396F1FB088FE38(&uLocal_1328);
					unk_0x092B9247AF00F5CF(0, 0, 0);
				
					if (unk_0x4FAFF4BCB7633475(iLocal_1050) && !func_50(func_148(), unk2, false))
					{
					...
					else
					{
						...
						if (!unk_0x1C2F771CDC87A3A5(iLocal_1050, 0))
							unk_0x329B82704ED2A3E3(0, iLocal_1050, 0f, -1.5f, 0f, 2f, -1, 1036831949, 1);
					}
		...
		case 4:
			if (!unk_0x1C2F771CDC87A3A5(uLocal_1051[iParam0], 0))
			{
				if (unk_0x13CCB1AD131C1082(uLocal_1051[iParam0], "oddjobs@assassinate@hotel@", "enter", 3))
				{
					num3 = unk_0x82E64DE58A6B84A8(uLocal_1051[iParam0], "oddjobs@assassinate@hotel@", "enter");
				
					if (num3 < 0.5f)
						unk_0x458AA1A01F53901E(uLocal_1051[iParam0], "oddjobs@assassinate@hotel@", "enter", 3.5f);
					else
						unk_0x458AA1A01F53901E(uLocal_1051[iParam0], "oddjobs@assassinate@hotel@", "enter", 1f);
				}
			}
			break;
		...
		case 5:
			...
			if (!unk_0x4FAFF4BCB7633475(iLocal_1050))
			{
				if (!unk_0x4FAFF4BCB7633475(uLocal_1051[iParam0]))
					if (unk_0x7F420695E3F776FB(iLocal_1050, 0))
						unk_0x62A5310368A20EFA(uLocal_1051[iParam0], iLocal_1049, 0, 16);
					else
						unk_0x2433FB137DF847D2(uLocal_1051[iParam0], iLocal_1050, unk_0x4A8C381C258A124D(), 3f, 1, 0.005f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
	...
	else if (uLocal_1045[iParam0] < 5)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_1051[iParam0]))
		{
			...
			unk_0x16C7AB5DAFB71459(uLocal_1051[iParam0]);
			unk_0xD0764B65C2DFEDCA(uLocal_1051[iParam0], 2);
			unk_0xBE8796DB2B90A437(uLocal_1051[iParam0], 13, 1);
		}
...
void func_150() // Position - 0x74B5
{
	...
	if (unk_0xFC8BFE4B41177C22(iLocal_1050))
		uLocal_1309 = { unk_0xD1A6A821F5AC81DB(iLocal_1050, 0) };
	...
	switch (iLocal_1044)
	{
		case 0:
			if (!unk_0x1C2F771CDC87A3A5(iLocal_1050, 0))
			{
				if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0) && !unk_0x1C2F771CDC87A3A5(uLocal_1054[0], 0))
				{
					if (!unk_0xCECDBB848D53DEB2(iLocal_1050, iLocal_1316, 0))
					{
						if (unk_0x9B5C1660CCDF7189(iLocal_1050, joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 1)
						{
							if (!bLocal_1138 && !bLocal_1162)
								unk_0xEBA229B2E0BB05E0(iLocal_1050, iLocal_1316, 30000, 1, 1f, 1, 0);
							else
								unk_0xEBA229B2E0BB05E0(iLocal_1050, iLocal_1316, 30000, 1, 2f, 1, 0);
		...
		case 1:
			...
			if (!bLocal_1183)
				if (func_152())
					if (func_30(iLocal_1050, unk_0x4A8C381C258A124D(), 1) <= 5f && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		...
		case 4:
			if (!unk_0x1C2F771CDC87A3A5(iLocal_1050, 0))
			{
				if (unk_0xCECDBB848D53DEB2(iLocal_1050, iLocal_1316, 0))
				{
					if (unk_0x9B5C1660CCDF7189(iLocal_1050, joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) != 1)
						unk_0x092B9247AF00F5CF(iLocal_1050, 0, 256);
				}
				else if (!bLocal_1168)
				{
					unk_0x4190C67D524CD0DC(iLocal_1050, 2f);
					unk_0xD0557B139A542F12(&unk);
					unk_0xB5396F1FB088FE38(&unk);
					unk_0x10425721983AE158(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1000, 0, 0, 0, 0, 0);
					unk_0xD844F5E50DAB6FF7(0, iLocal_1049, 200f, -1, 0, 0);
					unk_0x93C0674FC00824D0(unk);
				
					if (!unk_0x1C2F771CDC87A3A5(iLocal_1050, 0))
						unk_0x4BD42B0527065BB6(iLocal_1050, unk);
				
					unk_0xD0557B139A542F12(&unk);
					bLocal_1168 = true;
				}
				else if (unk_0x9B5C1660CCDF7189(iLocal_1050, joaat("SCRIPT_TASK_ANY")) != 1)
				{
					unk_0xD844F5E50DAB6FF7(iLocal_1050, iLocal_1049, 200f, -1, 0, 0);
				}
...
BOOL func_152() // Position - 0x78A7
{
	...
	if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
	{
		num = unk_0xFD5C5BBD1FE92BB7(iLocal_1316, -1, 0);
	
		if (num == 0 || num != 0 && unk_0x4FAFF4BCB7633475(num))
		{
			num = unk_0xFD5C5BBD1FE92BB7(iLocal_1316, 0, 0);
		
			if (num == 0 || num != 0 && unk_0x4FAFF4BCB7633475(num))
			{
				num = unk_0xFD5C5BBD1FE92BB7(iLocal_1316, 2, 0);
...
void func_156() // Position - 0x7C19
{
	...
	switch (iLocal_1219)
	{
		...
		case 1:
			...
			if (func_241(&uLocal_388, true, 0) && unk_0x1FC87F78B679BE3D())
			{
...
void func_166(int iParam0) // Position - 0x88ED
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_168() /*5568*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113648.f_20566.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_168() /*5568*/].f_681.f_10), iParam0);
	}
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x8B7B
{
	...
	bParam4;
	num = Global_2805029[empsParam0 /*3*/][func_170(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x8DCF
{
	...
	{
		iParam2 == 0;
		unk = Global_2805029[empsParam0 /*3*/][func_170(iParam1)];
...
void func_201(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x955C
{
	...
	if (!func_207(uParam0->f_1, 256) || func_207(uParam0->f_1, 8192) && unk_0x7811C74D5B749F76(2))
	{
		...
		if (unk_0x761778199FE1211C())
		{
			...
			unk_0x557F1E2300EF1A3E(func_207(uParam0->f_1, 4096));
			unk_0xE6B753D52F4CA222();
		}
...
void func_210(var uParam0, BOOL bParam1) // Position - 0x9F04
{
	...
	func_206(unk_0xE934399D6F2C3AC5(2, 215, 1));
	...
	if (bParam1)
	{
		unk_0x88F483FBD433696A(uParam0->f_4, "SET_DATA_SLOT");
		unk_0x330108B080A2132F(1);
		func_206(unk_0xE934399D6F2C3AC5(2, 216, 1));
...
void func_212(var uParam0, int iParam1, int iParam2) // Position - 0x9FEF
{
	...
	if (num12 >= 0f)
	{
		...
		func_230();
		unk_0x81645EE95A114FAE(0.5f, num2 - func_233(2f - 0.5f) - 0.0013888889f, num7, func_227(1f), unk, unk2, unk3, SYSTEM::ROUND(num13 * (float)num14), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_560 == 4)
		{
			if (i == uParam0->f_580 - 1)
			{
				...
				if (num12 >= 0f)
				{
					...
					num13 = func_211(num12 / (0.6f * func_233(25f)), 0f, 1f);
					func_230();
					unk_0x81645EE95A114FAE(0.5f, num2 + func_233(2f * 0.5f), num7, func_227(1f), unk, unk2, unk3, SYSTEM::ROUND(num13 * (float)num14), 0);
					num2 = num2 + func_233(2f * 0.3f);
		...
		if (num12 >= 0f)
		{
			...
			switch (uParam0->f_560)
			{
				case 0:
					...
					unk_0x25DD447A6EB3A86F(num16, num2 + func_233(2f * 2f), 0);
					break;
...
char* func_220(int iParam0, BOOL bParam1) // Position - 0xAFFC
{
	...
	if (!unk_0xD6F9DEE4765092A9(&Global_23270.f_7488[iParam0 /*16*/]))
	{
		...
		{
			unk20 = { func_222(unk_0x259BE71D8A81D4FA()) };
...
char* func_223(int iParam0) // Position - 0xB545
{
	...
	if (!unk_0xD6F9DEE4765092A9(&Global_23270.f_6463[iParam0 /*16*/]))
	{
		...
		{
			unk17 = { func_222(unk_0x259BE71D8A81D4FA()) };
...
void func_224(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0xB5BA
{
	...
	unk_0x2873B596E322DCDA(1);
	unk_0xBFE94E91C83D8794(1f, func_226(14f));
	unk_0xEAF65721ACB2FDFB(0);
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			unk_0xFFA2B456A81EA1EB("CommonMenu", func_220(7, false), fParam4 - 0.006f, fParam2 + func_233(2f) + (0.25f * unk5), num2, unk5, 0f, 255, 255, 255, iParam5, 0, 0);
			num = num - ((num2 * 0.38f) + 0.006f);
			break;
	
		case 2:
			func_216(5, false, true, &num2, &unk5, false);
			unk_0xFFA2B456A81EA1EB("CommonMenu", func_220(5, false), fParam4 - 0.006f, fParam2 + func_233(2f) + (0.25f * unk5), num2, unk5, 0f, 255, 255, 255, iParam5, 0, 0);
			num = num - ((num2 * 0.38f) + 0.006f);
			break;
	
		case 3:
			func_216(6, false, true, &num2, &unk5, false);
			unk_0xFFA2B456A81EA1EB("CommonMenu", func_220(6, false), fParam4 - 0.006f, fParam2 + func_233(2f) + (0.25f * unk5), num2, unk5, 0f, 255, 255, 255, iParam5, 0, 0);
			num = num - ((num2 * 0.38f) + 0.006f);
			break;
	}
...
void func_225(int iParam0, var uParam1, float fParam2, float fParam3, var uParam4, int iParam5) // Position - 0xB848
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			unk_0xBFE94E91C83D8794(1f, func_226(18f));
...
void func_242(var uParam0) // Position - 0xC0AE
{
	...
	unk_0x88F483FBD433696A(uParam0->f_4, "SET_DATA_SLOT");
	unk_0x330108B080A2132F(2);
	func_206(unk_0xE934399D6F2C3AC5(2, 188, 1));
	func_205("ES_HELP_TU" /*Like*/);
	unk_0xE6B753D52F4CA222();
	unk_0x88F483FBD433696A(uParam0->f_4, "SET_DATA_SLOT");
	unk_0x330108B080A2132F(1);
	func_206(unk_0xE934399D6F2C3AC5(2, 187, 1));
	func_205("ES_HELP_TD" /*Dislike*/);
	unk_0xE6B753D52F4CA222();
	unk_0x88F483FBD433696A(uParam0->f_4, "SET_DATA_SLOT");
	unk_0x330108B080A2132F(0);
	func_206(unk_0xE934399D6F2C3AC5(2, 202, 1));
...
void func_243(var uParam0) // Position - 0xC173
{
	...
	num = 0f;
	unk_0x2873B596E322DCDA(0);
	unk_0xBFE94E91C83D8794(1f, func_226(16f));
...
void func_245() // Position - 0xC2FA
{
	...
	if (!bLocal_377)
	{
		...
		else
		{
			...
			if (!unk_0xD6F9DEE4765092A9(&(uLocal_969.f_18)))
			{
				if (bLocal_375)
				{
...
void func_254() // Position - 0xC9C8
{
	...
	switch (iLocal_1197)
	{
		...
		case 1:
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				num = func_32(unk_0x4A8C381C258A124D(), uLocal_1303, 1);
...
void func_256() // Position - 0xCB26
{
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1051[i]))
		{
			if (!unk_0x4FAFF4BCB7633475(uLocal_1051[i]))
			{
				...
				unk_0x974022927CB47E68(uLocal_1051[i]);
				unk_0xF09E30AF1B8FB379(&uLocal_1051[i]);
			}
		}
	}
	...
	if (unk_0xFC8BFE4B41177C22(iLocal_1050))
	{
		if (!unk_0x4FAFF4BCB7633475(iLocal_1050))
		{
			unk_0x974022927CB47E68(iLocal_1050);
			unk_0xF09E30AF1B8FB379(&iLocal_1050);
		}
	}
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1054[i]))
		{
			if (!unk_0x4FAFF4BCB7633475(uLocal_1054[i]))
			{
				...
				unk_0x974022927CB47E68(uLocal_1054[i]);
				unk_0xF09E30AF1B8FB379(&uLocal_1054[i]);
			}
		}
	}
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_1058[i]))
		{
			if (!unk_0x4FAFF4BCB7633475(uLocal_1058[i]))
			{
				...
				unk_0x974022927CB47E68(uLocal_1058[i]);
				unk_0xF09E30AF1B8FB379(&uLocal_1058[i]);
			}
		}
	}
...
void func_261() // Position - 0xCE26
{
	...
	{
		if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
			unk_0x0B74F181ADFC39BF(iLocal_1316, 1);
	
		unk_0x68298CA6191CDFDB(&iLocal_1316);
	}

	if (unk_0xFC8BFE4B41177C22(iLocal_1317))
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_1317, 0))
		{
			if (unk_0xCB5CAFF0A4A8B74B(iLocal_1317) && !unk_0xF6C26AE940C14749(iLocal_1317) && !unk_0x15CCE8886267624F())
			{
				unk_0x68298CA6191CDFDB(&iLocal_1317);
			}
			else
			{
				if (unk_0xFC8BFE4B41177C22(uLocal_1058[0]) && !unk_0x1C2F771CDC87A3A5(uLocal_1058[0], 0))
					if (!unk_0x1C2F771CDC87A3A5(iLocal_1317, 0))
						if (unk_0xCECDBB848D53DEB2(uLocal_1058[0], iLocal_1317, 0))
							unk_0x19626F992DC71FB9(uLocal_1058[0]);
			
				if (unk_0xFC8BFE4B41177C22(uLocal_1058[1]) && !unk_0x1C2F771CDC87A3A5(uLocal_1058[1], 0))
					if (!unk_0x1C2F771CDC87A3A5(iLocal_1317, 0))
						if (unk_0xCECDBB848D53DEB2(uLocal_1058[1], iLocal_1317, 0))
							unk_0x19626F992DC71FB9(uLocal_1058[1]);
			
				if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
					if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), iLocal_1317, 0))
	...
	if (unk_0xFC8BFE4B41177C22(uLocal_1320[0]))
		unk_0x68298CA6191CDFDB(&uLocal_1320[0]);

	if (unk_0xFC8BFE4B41177C22(uLocal_1320[1]))
		unk_0x68298CA6191CDFDB(&uLocal_1320[1]);

	if (unk_0xFC8BFE4B41177C22(iLocal_1323) && !unk_0x1C2F771CDC87A3A5(iLocal_1323, 0))
		if (unk_0x110821AE6C63DD4F(iLocal_1323) && unk_0x7C9905528EE2C3AB(iLocal_1323, 1))
			unk_0x68298CA6191CDFDB(&iLocal_1323);
...
void func_262(BOOL bParam0) // Position - 0xCFAC
{
	...
	if (bParam0)
		if (unk_0xC450B06E5AAA0985(iLocal_1124))
			unk_0xFE54B8568B2ABD12(&iLocal_1124);

	for (i = 0; i < 3; i = i + 1)
	{
		if (unk_0xC450B06E5AAA0985(uLocal_1125[i]))
			unk_0xFE54B8568B2ABD12(&uLocal_1125[i]);
	}

	for (i = 0; i < 2; i = i + 1)
	{
		if (unk_0xC450B06E5AAA0985(uLocal_1129[i]))
			unk_0xFE54B8568B2ABD12(&uLocal_1129[i]);
	}
...
{
	if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_1297, uLocal_1300, fLocal_1247, 1, 0, 0))
		bLocal_1156 = true;
	else
		bLocal_1156 = false;
...
void func_265() // Position - 0xD0C3
{
	if (!bLocal_1153)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_1316))
		{
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
			{
				unk_0x0B74F181ADFC39BF(iLocal_1316, 3);
	...
	switch (iLocal_1197)
	{
		case 0:
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
			{
				if (func_140())
				{
					if (!unk_0x4FAFF4BCB7633475(uLocal_1054[0]))
					{
						if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
						{
							if (unk_0xCECDBB848D53DEB2(uLocal_1054[0], iLocal_1316, 0))
							{
								bLocal_1149 = true;
								func_264();
								iLocal_1035 = 13;
...
void func_272() // Position - 0xD2D2
{
	...
	unk_0x55098D9E9AD58806(iLocal_1332);
	return;
}
...
void func_276() // Position - 0xD393
{
	...
	if (unk_0xFC8BFE4B41177C22(iLocal_1050) && !unk_0x1C2F771CDC87A3A5(iLocal_1050, 0))
	{
		unk8 = { unk_0xD1A6A821F5AC81DB(iLocal_1050, 1) };
		unk11 = unk_0xCFC0C995455A6204(iLocal_1050);
	}
	...
	{
		if (i == 0)
			uLocal_1051[i] = unk_0xB1DBFEB95C0EFB88(26, iLocal_1331, unk[0 /*3*/], unk[0 /*3*/].f_1, 38.3253f, uLocal_1243[iLocal_1206], 1, 1);
		else
			uLocal_1051[i] = unk_0xB1DBFEB95C0EFB88(26, iLocal_1332, unk[1 /*3*/], unk[1 /*3*/].f_1, 38.3253f, uLocal_1243[iLocal_1206], 1, 1);
	
		unk_0x788F35D395511DFE(uLocal_1051[i], 1, 1);
		unk_0x77EFA99E6A8FFC43(uLocal_1051[i]);
		unk_0xBE8796DB2B90A437(uLocal_1051[i], 3, 0);
		unk_0xBE8796DB2B90A437(uLocal_1051[i], 23, 1);
		unk_0xBE8796DB2B90A437(uLocal_1051[i], 30, 0);
		unk_0xBE8796DB2B90A437(uLocal_1051[i], 13, 1);
		unk_0x570AAA413775DFFB(uLocal_1051[i], 2);
		unk_0x44FB298D6382876D(uLocal_1051[i], 1);
		func_277(uLocal_1051[i], true);
		unk_0x70FF391C9D345B04(uLocal_1051[i], 1);
	}
...
void func_277(var uParam0, BOOL bParam1) // Position - 0xD4E8
{
	...
	unk_0x3CEA1FD137ACE2D9(uParam0, uLocal_1336);
	return;
}
...
{
	func_280();
	iLocal_1206 = unk_0xC5935DFB3F39785A(0, iLocal_1199);
	iLocal_1050 = unk_0xB1DBFEB95C0EFB88(26, iLocal_1329, uLocal_1262[iLocal_1206 /*3*/], uLocal_1243[iLocal_1206], 1, 1);
	unk_0x788F35D395511DFE(iLocal_1050, 1, 1);
	unk_0x77EFA99E6A8FFC43(iLocal_1050);
	...
	unk_0x5D3946F818C6B331(iLocal_1124, 1f);
	return;
}
...
void func_280() // Position - 0xD66D
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!unk_0x7B780C491DEC834E(uLocal_1252[i /*3*/], 5f) && !func_284(i, 6f))
		{
...
{
	if (unk_0x913602ADD2D86A7A(uLocal_1252[iParam0 /*3*/], fParam1))
		return true;
...
BOOL func_286() // Position - 0xD8F2
{
	...
	if (unk_0x6252BC0DD8A320DB(iLocal_1329))
		num = 1;
	else
		num = 0;
...
{
	if (unk_0xFC8BFE4B41177C22(uLocal_1054[0]) && unk_0xFC8BFE4B41177C22(uLocal_1054[1]) && !unk_0x4FAFF4BCB7633475(uLocal_1054[0]) && !unk_0x4FAFF4BCB7633475(uLocal_1054[1]))
		if (unk_0xCECDBB848D53DEB2(uLocal_1054[0], iLocal_1316, 0) && unk_0xCECDBB848D53DEB2(uLocal_1054[1], iLocal_1316, 0))
			return true;
...
void func_289() // Position - 0xD9AF
{
	switch (iLocal_1197)
	{
		case 0:
			...
			if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
				unk_0xC229299217554C78(iLocal_1316, 0, 1, 0);
			...
			unk_0x0B0C9A0F9AAEB7F0(&uLocal_360, 4);
	...
	*uParam0 = unk_0xF0CA45A211FFDCD9(-1221.954f, -210.746f, 38.638f, 27f, 0, 4);
	...
	if (iLocal_1323 != 0)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_1323) && !unk_0x1C2F771CDC87A3A5(iLocal_1323, 0))
		{
			...
			{
				unk = { unk_0xD1A6A821F5AC81DB(iLocal_1323, 1) };
				return true;
			}
		}
	}
...
void func_293() // Position - 0xDBE0
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!unk_0xFC8BFE4B41177C22(uLocal_1054[i]))
		{
			...
			uLocal_1054[i] = unk_0xB1DBFEB95C0EFB88(26, num, uLocal_1272[i /*3*/], uLocal_1225[i], 1, 1);
		
			if (i == 0)
			{
				unk_0xD1C578C204015E1F(uLocal_1054[i], 0, 0, 2, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 3, 0, 0, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 4, 0, 1, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 8, 0, 0, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 11, 0, 0, 0);
			}
			else if (i == 1)
			{
				unk_0xD1C578C204015E1F(uLocal_1054[i], 0, 1, 2, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 3, 0, 1, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 4, 0, 0, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 8, 0, 0, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 11, 0, 2, 0);
			}
			else if (i == 2)
			{
				unk_0xD1C578C204015E1F(uLocal_1054[i], 0, 1, 2, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 3, 0, 2, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 4, 0, 1, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 8, 0, 0, 0);
				unk_0xD1C578C204015E1F(uLocal_1054[i], 11, 1, 1, 0);
			}
		}
	
		if (!unk_0x4FAFF4BCB7633475(uLocal_1054[i]))
		{
			unk_0x3F58BFCF656F0DF1(uLocal_1054[i], 0);
			unk_0x44FB298D6382876D(uLocal_1054[i], 1);
			unk_0xBE8796DB2B90A437(uLocal_1054[i], 23, 1);
			unk_0xBE8796DB2B90A437(uLocal_1054[i], 30, 0);
			unk_0x570AAA413775DFFB(uLocal_1054[i], 2);
			unk_0x0428AFDCAA63B06E(uLocal_1054[i], 104, 1);
...
void func_294() // Position - 0xDDA5
{
	func_296();
	func_295();
	unk_0x55098D9E9AD58806(iLocal_1333);
	return;
}
...
void func_295() // Position - 0xDDBC
{
	...
	for (i = 0; i < 2; i = i + 1)
	{
		...
		{
			if (i == 0)
				uLocal_1058[i] = unk_0x8728A378EF2B46B2(iLocal_1317, 26, iLocal_1331, -1, 1, 1);
			else if (i == 1)
				uLocal_1058[i] = unk_0x8728A378EF2B46B2(iLocal_1317, 26, iLocal_1332, 0, 1, 1);
		
			func_277(uLocal_1058[i], true);
			unk_0xBE8796DB2B90A437(uLocal_1058[i], 3, 0);
			unk_0xBE8796DB2B90A437(uLocal_1058[i], 23, 1);
			unk_0xBE8796DB2B90A437(uLocal_1058[i], 30, 0);
			unk_0x570AAA413775DFFB(uLocal_1058[i], 2);
			unk_0x44FB298D6382876D(uLocal_1058[i], 1);
		}
	}
...
void func_296() // Position - 0xDE70
{
	if (!unk_0xFC8BFE4B41177C22(iLocal_1317))
	{
		iLocal_1317 = unk_0x5779387E956077A6(iLocal_1333, uLocal_1288, fLocal_1237, 1, 1, 0);
		unk_0x20DD46D27530FAC7(iLocal_1317, 0);
	}
		...
		if (unk_0xFC8BFE4B41177C22(Global_98012[i]))
			if (Global_98012[i] == uParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98022[i])
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(uParam0) == func_304(echParam1, iParam2))
						return 1;
	}
		...
		*uParam1 = unk_0x4F06416A18248EA0(uParam0);
		...
		for (i = 0; i <= 11; i = i + 1)
		{
			if (unk_0x5318DF85BEB6B95F(uParam0, i + 1))
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(i + 1));
		}
...
void func_311(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE9F4
{
	...
	if (num == 1)
	{
		...
		num2 = func_381(unk_0x1AF90EB93E0012D6(), true);
		...
		{
			num4 = func_374(unk_0x1AF90EB93E0012D6(), 1);
...
{
	func_313(&Global_107196, unk_0x1AF90EB93E0012D6(), iParam0, sParam1, iParam3, iParam2);
	return;
}
...
void func_313(var uParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xEB85
{
	...
	*uParam0 = _GET_CURRENT_PLAYER_CHARACTER();
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		...
		func_331(unk_0x4A8C381C258A124D());
		func_324(unk_0x4A8C381C258A124D(), false);
	...
	for (j = CHAR_MICHAEL; j < CHAR_MULTIPLAYER; j = j + 1)
	{
		...
		{
			func_319(unk_0x4A8C381C258A124D(), &uParam0->f_616[j /*65*/], 1, -1);
		}
		else
		{
			for (i = 0; i < 12; i = i + 1)
...
BOOL func_320(int iParam0, int iParam1) // Position - 0xFECD
{
	...
	unk = Global_2848282[iParam0 /*3*/][func_170(iParam1)];
...
void func_325(var uParam0, var uParam1) // Position - 0x10790
{
	...
	if (!unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		for (i = 0; i <= 44 - 1; i = i + 1)
		{
			...
			if (num != 0)
			{
				num2 = unk_0xBCEDAE6CA2B2046E(uParam0, func_330(i));
				num2.f_1 = 0;
				num2.f_2 = 0;
				num2.f_3 = 0;
				num2.f_4 = 0;
		...
		{
			if (unk_0xA40B513DA7201333(l, &unk5) && !func_327(unk5.f_1) && num4 < 51)
			{
...
BOOL func_335(var uParam0) // Position - 0x128F1
{
	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		if (func_360())
		{
			*uParam0 = func_341(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), 6, -1, false, true, -1);
...
int func_341(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x12D71
{
	...
	for (i = 0; i <= 59; i = i + 1)
	{
		if (iParam3 == 6 || iParam3 == func_359(i))
		{
			...
			{
				num = unk_0xED977E2AE2CB16EE(uParam0, func_342(i, false), 1);
...
var func_361() // Position - 0x14D94
{
	...
	func_371(&unk, unk_0x4BA5A16068183C5E());
	func_370(&unk, unk_0x18E502A71E28968C());
	func_369(&unk, unk_0x5295501D0862870D());
	func_364(&unk, unk_0xB12880C92EA6EE15());
	func_363(&unk, unk_0x8825A6E0A30BDCB8());
	func_362(&unk, unk_0x7598FE4545010A75());
	return unk;
}
...
void func_384() // Position - 0x16D77
{
	...
	{
		case 0:
			if (func_414(1084227584, 1) || bLocal_1155 && unk_0xE945B67B28139DA2(uLocal_1134))
			{
				...
				if (!unk_0x1C2F771CDC87A3A5(iLocal_1316, 0))
				{
					if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
					{
						unk_0x88556DA0593A0748(iLocal_1316, 107, "ASSOJva", 1);
						unk_0x8BCD7C11D27FB9A1(iLocal_1316, 2500f);
					}
				}
			...
			else if (unk_0xE945B67B28139DA2(uLocal_1134))
			{
			}
			break;
...
BOOL func_385() // Position - 0x16EC4
{
	...
	switch (iLocal_1198)
	{
		case 0:
			func_410(0, 0, true);
			func_409();
			unk_0x2A09425009DAD0F5(uLocal_1334, "HAND_SHAKE", 0.2f);
			unk_0x2A09425009DAD0F5(uLocal_1335, "HAND_SHAKE", 0.2f);
			unk_0xB56F35D8A770F80F(uLocal_1335, uLocal_1334, 6000, 0, 0);
		...
		case 1:
			if (!unk_0x1C2F771CDC87A3A5(iLocal_1316, 0))
			{
				if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
				{
					...
					{
						if (unk_0x050D073F91C5243C(iLocal_1316))
							unk_0x1D2DAF2A41FFC4A0(iLocal_1316);
					
						unk_0x88556DA0593A0748(iLocal_1316, 102, "ASSOJva", 1);
						unk_0x8BCD7C11D27FB9A1(iLocal_1316, 4500f);
						unk_0x44A13535A15C20E0(iLocal_1316, 1);
						_SHOW_SUBTITLE_CLEAR_EXISTING("ASS_VA_SNIPE2", 7500, 1);
						unk_0xA3774254665BAA82(uLocal_1334, -1218.8607f, -191.0496f, 38.83616f, 3.519839f, -0.000706f, 42.27108f, 38f, 0, 1, 1, 2);
						unk_0x1991568378B6C0D0(uLocal_1334, 0.5f);
						unk_0x12DA57732DE5D8BB(uLocal_1334, 7f);
						unk_0x2A09425009DAD0F5(uLocal_1334, "HAND_SHAKE", 0.2f);
						unk_0xA3774254665BAA82(uLocal_1335, -1218.9097f, -190.87914f, 38.84585f, 3.519839f, -0.000706f, 43.338146f, 38f, 0, 1, 1, 2);
						unk_0x1991568378B6C0D0(uLocal_1335, 0.7f);
						unk_0x12DA57732DE5D8BB(uLocal_1335, 10f);
						unk_0x2A09425009DAD0F5(uLocal_1335, "HAND_SHAKE", 0.2f);
						unk_0xB56F35D8A770F80F(uLocal_1335, uLocal_1334, 2000, 3, 3);
						iLocal_1198 = iLocal_1198 + 1;
					}
				}
			}
		...
		case 2:
			if (!unk_0x1C2F771CDC87A3A5(iLocal_1316, 0))
			{
				if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
				{
					if (unk_0x157F3D5A4AAB2C50(iLocal_1316) >= 7000f)
					{
						unk_0x36D3AD4491CD32BA(iLocal_1316);
					
						for (iLocal_1196 = 0; iLocal_1196 < 3; iLocal_1196 = iLocal_1196 + 1)
						{
							if (!unk_0x1C2F771CDC87A3A5(uLocal_1054[iLocal_1196], 0))
							{
								if (iLocal_1196 == 0)
									num = 1250;
								...
								if (unk_0x9B5C1660CCDF7189(uLocal_1054[iLocal_1196], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1)
								{
									unk_0xD0557B139A542F12(&uLocal_1328);
									unk_0xB5396F1FB088FE38(&uLocal_1328);
									unk_0x092B9247AF00F5CF(0, num, 0);
									unk_0xA966E518B752B92A(0, uLocal_1252[iLocal_1196 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
									unk_0x93C0674FC00824D0(uLocal_1328);
									unk_0x4BD42B0527065BB6(uLocal_1054[iLocal_1196], uLocal_1328);
									unk_0xD0557B139A542F12(&uLocal_1328);
								}
							}
						}
		...
		case 3:
			if (SYSTEM::TIMERA() >= 2000)
			{
				...
				{
					unk_0xA3774254665BAA82(uLocal_1334, -1265.5488f, -213.4919f, 43.0913f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					unk_0x2A09425009DAD0F5(uLocal_1334, "HAND_SHAKE", 0.2f);
					unk_0xA3774254665BAA82(uLocal_1335, -1266.0629f, -213.922f, 43.0918f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					unk_0x2A09425009DAD0F5(uLocal_1335, "HAND_SHAKE", 0.2f);
					unk_0xB56F35D8A770F80F(uLocal_1335, uLocal_1334, 4000, 3, 3);
					iLocal_1221 = 4000;
				}
				else
				{
					unk_0xA3774254665BAA82(uLocal_1334, -1266.1925f, -215.217f, 43.2442f, -3.1088f, 0.0498f, -48.5594f, 38f, 0, 1, 1, 2);
					unk_0x2A09425009DAD0F5(uLocal_1334, "HAND_SHAKE", 0.2f);
					unk_0xA3774254665BAA82(uLocal_1335, -1267.5302f, -215.7824f, 43.1067f, -9.2365f, 0.0498f, -48.3561f, 38f, 0, 1, 1, 2);
					unk_0x2A09425009DAD0F5(uLocal_1335, "HAND_SHAKE", 0.2f);
					unk_0xB56F35D8A770F80F(uLocal_1335, uLocal_1334, 4000, 3, 3);
					iLocal_1221 = 4000;
				}
		...
		case 4:
			...
			if (SYSTEM::TIMERA() >= iLocal_1221)
			{
				...
				unk_0x6515021478088FBC(iLocal_1316, 1, 1);
				unk_0x6515021478088FBC(iLocal_1316, 0, 1);
				unk_0x6515021478088FBC(iLocal_1316, 2, 1);
				unk_0x428C32CC68809A35(1);
...
void func_386(BOOL bParam0) // Position - 0x173AC
{
	...
	if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
	{
		...
		unk_0x7821F942CAEEBEE1(102, "ASSOJva");
		unk_0x7821F942CAEEBEE1(107, "ASSOJva");
		unk_0xB2BD5837A8D3CEDA(iLocal_1316, uLocal_1294, 1, 0, 0, 1);
		unk_0x5C96CEA06531AB03(iLocal_1316, fLocal_1224);
		unk_0x6515021478088FBC(iLocal_1316, 0, 1);
		unk_0x6515021478088FBC(iLocal_1316, 1, 1);
		unk_0x6515021478088FBC(iLocal_1316, 2, 1);
		unk_0x6515021478088FBC(iLocal_1316, 2, 1);
...
{
	if (func_389() && unk_0x1DD05E817C89C737() >= iParam0 + 1000)
	{
...
void func_392(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x17549
{
	...
	else
	{
		...
		if (unk_0x76CD105BCAC6EB9F())
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_396(unk_0x259BE71D8A81D4FA()) && !_NETWORK_IS_PLAYER_IN_SCTV(unk_0x259BE71D8A81D4FA(), 0) && !func_393() && !bParam4 && !bParam5 && !unk_0xAD15761928FCF79C())
				unk_0x935364B4448CD584(unk_0x4A8C381C258A124D(), 0);
		else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_396(unk_0x259BE71D8A81D4FA()) && !bParam4 && !bParam5)
			unk_0x935364B4448CD584(unk_0x4A8C381C258A124D(), 0);
...
void func_408() // Position - 0x180EE
{
	...
	{
		unk_0x19626F992DC71FB9(unk_0x4A8C381C258A124D());
		unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), uLocal_1306, 1, 0, 0, 1);
		unk_0x5C96CEA06531AB03(unk_0x4A8C381C258A124D(), 299.4985f);
	}

	if (unk_0xFC8BFE4B41177C22(uLocal_1319))
	{
		if (unk_0xD9F5E1FEFD1329E4(uLocal_1319, 0))
		{
			unk_0xC229299217554C78(uLocal_1319, 0, 1, 0);
			unk_0xB2BD5837A8D3CEDA(uLocal_1319, -1251.8732f, -256.7999f, 38.2695f, 1, 0, 0, 1);
			unk_0x5C96CEA06531AB03(uLocal_1319, 296.7603f);
			unk_0x1DE99C193C7EC64B(uLocal_1319, 1084227584);
		}
	}
...
void func_411() // Position - 0x181E5
{
	if (unk_0xFC8BFE4B41177C22(iLocal_1316))
	{
		if (unk_0xD9F5E1FEFD1329E4(iLocal_1316, 0))
		{
			for (iLocal_1196 = 0; iLocal_1196 < 3; iLocal_1196 = iLocal_1196 + 1)
			{
				if (!unk_0xFC8BFE4B41177C22(uLocal_1054[iLocal_1196]))
				{
					if (iLocal_1196 == 0)
					{
						uLocal_1054[iLocal_1196] = unk_0x8728A378EF2B46B2(iLocal_1316, 26, iLocal_1331, -1, 1, 1);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 0, 0, 2, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 3, 0, 0, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 4, 0, 1, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 8, 0, 0, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 11, 0, 0, 0);
					}
					else if (iLocal_1196 == 1)
					{
						uLocal_1054[iLocal_1196] = unk_0x8728A378EF2B46B2(iLocal_1316, 26, iLocal_1331, 0, 1, 1);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 0, 1, 2, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 3, 0, 1, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 4, 0, 0, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 8, 0, 0, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 11, 0, 2, 0);
					}
					else if (iLocal_1196 == 2)
					{
						uLocal_1054[iLocal_1196] = unk_0x8728A378EF2B46B2(iLocal_1316, 26, iLocal_1332, 1, 1, 1);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 0, 1, 2, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 3, 0, 2, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 4, 0, 1, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 8, 0, 0, 0);
						unk_0xD1C578C204015E1F(uLocal_1054[iLocal_1196], 11, 1, 1, 0);
					}
				}
			}
		}
...
void func_412() // Position - 0x1837E
{
	if (!unk_0xFC8BFE4B41177C22(iLocal_1316))
	{
		iLocal_1316 = unk_0x5779387E956077A6(iLocal_1330, uLocal_1291, fLocal_1223, 1, 1, 0);
		unk_0x55098D9E9AD58806(iLocal_1330);
		unk_0x3B1F6012B676860B(iLocal_1316, 1);
		unk_0x788F35D395511DFE(iLocal_1316, 1, 1);
		unk_0x0248EA593ACD1C87(iLocal_1316, 1);
	}
...
BOOL func_414(int iParam0, int iParam1) // Position - 0x183EF
{
	...
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && func_415(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), iParam0, 1, 1056964608, 0, true, false) && !unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || !unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
	{
...
void func_417() // Position - 0x1865E
{
	...
	switch (iLocal_1197)
	{
		...
		case 1:
			...
			if (!unk_0xFC8BFE4B41177C22(iLocal_1323))
			{
				if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
				{
					if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
					{
						...
						{
							iLocal_1323 = unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0);
			...
			if (!unk_0x3EE1A6D743332852(unk_0x259BE71D8A81D4FA(), 0))
			{
				if (!func_427())
				{
					if (!unk_0xC450B06E5AAA0985(uLocal_1123))
					{
						uLocal_1123 = func_426(uLocal_1306, 1);
						unk_0x594D5D0D7071B0DE(uLocal_1123, "ASS_VA_DESTBLIP");
				...
				else if (unk_0xE945B67B28139DA2(uLocal_1134) && func_423())
				{
					func_422();
					func_264();
					iLocal_1035 = 8;
...
void func_418() // Position - 0x18803
{
	if (!bLocal_1136)
	{
		...
		{
			func_420();
			uLocal_1134 = unk_0x4F6F8824BE43F1F7(-1244.3435f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 80f, 12, 127);
			bLocal_1136 = true;
		}
	}
	else if (func_282(uLocal_1306, 1) > 120f)
	{
		if (unk_0x5561E31B168FA823(uLocal_1134))
		{
			unk_0x6C730FCE8A68AF6F(uLocal_1134);
			func_272();
			bLocal_1136 = false;
		}
	}
	else if (!unk_0x5561E31B168FA823(uLocal_1134))
	{
		if (!func_419())
			bLocal_1136 = false;
	}
...
void func_420() // Position - 0x188E7
{
	...
	unk_0xEC9DAA34BBB4658C(iLocal_1332);
	return;
}
...
{
	if (unk_0xC450B06E5AAA0985(uLocal_1123))
		unk_0xFE54B8568B2ABD12(&uLocal_1123);
...
BOOL func_423() // Position - 0x18947
{
	...
	if (unk_0x6252BC0DD8A320DB(iLocal_1331) && unk_0x6252BC0DD8A320DB(iLocal_1332))
		num = 1;
	else
		num = 0;
...
BOOL func_427() // Position - 0x189E7
{
	...
	if (func_428())
		if (unk_0x65FFA94B82A71741(iLocal_1049, uLocal_1306, 25f, 25f, 90f, 1, 1, 0))
			flag = true;

	if (unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) == 0)
		if (num < 2f || unk_0x65FFA94B82A71741(iLocal_1049, uLocal_1306, 2f, 2f, 2f, 1, 1, 0) || flag)
...
BOOL func_428() // Position - 0x18AC6
{
	...
	{
		uLocal_1319 = unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0);
		num = unk_0x4B423FAA24E8ABF0(uLocal_1319);
...
void func_429() // Position - 0x18B3D
{
	...
	switch (iLocal_1209)
	{
		...
		case 1:
			uLocal_1695[0] = unk_0xB1DBFEB95C0EFB88(4, joaat("A_F_M_BevHills_01"), -1220.6788f, -203.2689f, 38.3251f, 321.2841f, 1, 1);
			uLocal_1695[1] = unk_0xB1DBFEB95C0EFB88(4, joaat("A_F_M_BevHills_02"), -1219.596f, -201.3663f, 38.3251f, 110.7199f, 1, 1);
			unk_0xAAA71DD7E9059338(uLocal_1695[0], 1);
			unk_0xAAA71DD7E9059338(uLocal_1695[1], 1);
			unk_0xB5396F1FB088FE38(&unk);
			unk_0xE67051907958B5EB(0, uLocal_1695[1], -1, 0, 2);
			unk_0x634E47EF112F3802(0, "WORLD_HUMAN_TOURIST_MOBILE", -1220.6788f, -203.2689f, 38.3251f, 321.2841f, 0, 0, 1);
			unk_0x93C0674FC00824D0(unk);
		
			if (!unk_0x1C2F771CDC87A3A5(uLocal_1695[0], 0))
				unk_0x4BD42B0527065BB6(uLocal_1695[0], unk);
		
			unk_0xD0557B139A542F12(&unk);
			unk_0xB5396F1FB088FE38(&unk);
			unk_0xE67051907958B5EB(0, uLocal_1695[0], -1, 0, 2);
			unk_0x634E47EF112F3802(0, "WORLD_HUMAN_TOURIST_MAP", -1219.596f, -201.3663f, 38.3251f, 110.7199f, 0, 0, 1);
			unk_0x93C0674FC00824D0(unk);
		
			if (!unk_0x1C2F771CDC87A3A5(uLocal_1695[1], 0))
				unk_0x4BD42B0527065BB6(uLocal_1695[1], unk);
		
			unk_0xD0557B139A542F12(&unk);
			uLocal_1695.f_4 = unk_0x5779387E956077A6(joaat("taxi"), -1221.7302f, -199.0665f, 38.1751f, 152.5038f, 1, 1, 0);
			unk_0x1DE99C193C7EC64B(uLocal_1695.f_4, 1084227584);
			uLocal_1695.f_3 = unk_0x8728A378EF2B46B2(uLocal_1695.f_4, 4, joaat("A_M_Y_Hipster_01"), -1, 1, 1);
			unk_0xAAA71DD7E9059338(uLocal_1695.f_3, 1);
			unk_0xE67051907958B5EB(uLocal_1695.f_3, uLocal_1695[0], -1, 0, 2);
			uLocal_1695.f_8[0] = unk_0xB1DBFEB95C0EFB88(4, joaat("A_M_M_BevHills_01"), -1211.5972f, -184.5331f, 38.3255f, 4.5193f, 1, 1);
			uLocal_1695.f_8[1] = unk_0xB1DBFEB95C0EFB88(4, joaat("A_M_Y_Hipster_01"), -1211.6544f, -182.7625f, 38.3255f, 166.2532f, 1, 1);
			unk_0xAAA71DD7E9059338(uLocal_1695.f_8[0], 1);
			unk_0xAAA71DD7E9059338(uLocal_1695.f_8[1], 1);
			unk_0x10425721983AE158(uLocal_1695.f_8[0], "oddjobs@assassinate@hotel@", "idle_a", 8f, -4f, -1, 1, 0, 0, 0, 0);
			unk_0x10425721983AE158(uLocal_1695.f_8[1], "oddjobs@assassinate@hotel@", "argue_b", 8f, -4f, -1, 1, 0, 0, 0, 0);
			uLocal_1695.f_5[0] = unk_0xB1DBFEB95C0EFB88(4, joaat("A_M_M_BevHills_01"), -1229.0994f, -176.3197f, 38.3255f, 231.8036f, 1, 1);
			uLocal_1695.f_5[1] = unk_0xB1DBFEB95C0EFB88(4, joaat("A_F_M_BevHills_02"), -1249.7793f, -162.4767f, 39.4131f, 220.1651f, 1, 1);
			unk_0xAAA71DD7E9059338(uLocal_1695.f_5[0], 1);
			unk_0xAAA71DD7E9059338(uLocal_1695.f_5[1], 1);
			unk_0x10425721983AE158(uLocal_1695.f_5[0], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			unk_0x10425721983AE158(uLocal_1695.f_5[1], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			uLocal_1695.f_11 = 1;
...
void func_430() // Position - 0x18F2C
{
	...
	if (bLocal_1190)
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		{
			fLocal_1249 = SYSTEM::VDIST(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_1306);
			bLocal_1190 = false;
		}
	}
...
void func_432() // Position - 0x1902C
{
	...
	if (unk_0xFC8BFE4B41177C22(iLocal_1062))
	{
		func_437();
	
		if (!unk_0x4FAFF4BCB7633475(iLocal_1062))
		{
			num = func_29(iLocal_1062, 1);
			unk_0xC1BC1B8A5AA67C6B(iLocal_1062, 0);
			unk_0xD9757FAB956617BA(iLocal_1062, 0);
			unk_0x3F58BFCF656F0DF1(iLocal_1062, 0);
			unk_0x72B18C9612CF3DA0(iLocal_1062, 16);
			unk_0x0428AFDCAA63B06E(iLocal_1062, 208, 1);
			...
			{
				if (unk_0xF6C26AE940C14749(iLocal_1062) || !unk_0xCB5CAFF0A4A8B74B(iLocal_1062))
					func_433();
			}
			...
			switch (iLocal_1195)
			{
				case 0:
					if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
					{
						if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()) || unk_0xFC8BFE4B41177C22(iLocal_1062) && unk_0x9B3D4335E0EDB0BE(iLocal_1062, unk_0x4A8C381C258A124D(), 1) || unk_0x9B3D4335E0EDB0BE(uLocal_1694, unk_0x4A8C381C258A124D(), 1))
						{
							unk_0x9B3D4335E0EDB0BE(uLocal_1694, unk_0x4A8C381C258A124D(), 1);
							unk_0x4669032A1DFBB449(iLocal_1062, "move_lester_CaneUp", 1048576000);
							unk_0x10425721983AE158(iLocal_1062, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0, 0, 0, 0);
							iLocal_1195 = 1;
						}
					}
					break;
				...
				case 1:
					if (unk_0x13CCB1AD131C1082(iLocal_1062, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3))
					{
						if (unk_0x82E64DE58A6B84A8(iLocal_1062, "oddjobs@assassinate@hotel@leadin", "Lester_Getup") >= 0.376f)
						{
							unk_0xB5396F1FB088FE38(&unk);
							...
							unk_0x761F56E633460973(0, unk_0xCFC0C995455A6204(iLocal_1062), 0);
							unk_0x93C0674FC00824D0(unk);
							unk_0x4BD42B0527065BB6(iLocal_1062, unk);
							unk_0xD0557B139A542F12(&unk);
							unk_0x717804C8C8DA67BF(iLocal_1062, joaat("MotionState_Walk"), 0, 0, 0);
							iLocal_1195 = 2;
						}
					}
					break;
...
{
	if (unk_0xFC8BFE4B41177C22(iLocal_1062))
		unk_0x734A9F4537A31459(&iLocal_1062);
...
{
	if (unk_0xFC8BFE4B41177C22(iLocal_1062))
		if (unk_0x9B3D4335E0EDB0BE(iLocal_1062, unk_0x4A8C381C258A124D(), 1))
			func_37(9);
...
{
	uLocal_1320[0] = unk_0x5779387E956077A6(iLocal_1333, -1270.0448f, -251.4953f, 41.4459f, 214.63f, 1, 1, 0);
	uLocal_1320[1] = unk_0x5779387E956077A6(iLocal_1333, -1265.1992f, -218.4823f, 45.9981f, 127.85f, 1, 1, 0);
	return;
}

void func_445() // Position - 0x1954A
{
	uLocal_1334 = unk_0x96A32328480B485C(joaat("DEFAULT_SCRIPTED_CAMERA"), -1244.3435f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
	uLocal_1335 = unk_0x96A32328480B485C(joaat("DEFAULT_SCRIPTED_CAMERA"), -1243.5876f, -251.4826f, 50.3187f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
	return;
}
...
void func_447() // Position - 0x19646
{
	...
	unk_0xEC9DAA34BBB4658C(iLocal_1333);
...
void func_449() // Position - 0x19760
{
	...
	unk_0x06CD913C241C765E("Guards", &uLocal_1336);
	unk_0xD414C47AFF81382A(1, joaat("COP"), uLocal_1336);
	unk_0xD414C47AFF81382A(1, uLocal_1336, joaat("COP"));
	unk_0xD414C47AFF81382A(5, uLocal_1336, joaat("PLAYER"));
	unk_0xD414C47AFF81382A(5, joaat("PLAYER"), uLocal_1336);
	...
	uLocal_1132 = unk_0xA7B0B03284E7503C(unk - { 15f, 15f, 15f }, unk + { 15f, 15f, 15f }, 0, 1, 1, 1);
	uLocal_1133 = unk_0xA7B0B03284E7503C(unk4 - { 45f, 35f, 35f }, unk4 + { 45f, 35f, 35f }, 0, 1, 1, 1);
	return;
}
...
void func_451() // Position - 0x19902
{
	...
	{
		uLocal_1231[iLocal_1196] = unk_0xD2AA6F822D3A55D2(0f, 2f);
	}
	...
	switch (iLocal_1197)
	{
		...
		case 1:
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
			{
				...
				unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), uLocal_1673, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(unk_0x4A8C381C258A124D(), fLocal_1676);
				...
				if (!unk_0x78411E34CF90EA8C(uLocal_1677))
				{
					uLocal_1677 = unk_0x96A32328480B485C(joaat("DEFAULT_SCRIPTED_CAMERA"), uLocal_1679, uLocal_1682, 42.203197f, 1, 2);
					unk_0x2A09425009DAD0F5(uLocal_1677, "HAND_SHAKE", 0.3f);
				}
			
				if (!unk_0x78411E34CF90EA8C(uLocal_1678))
				{
					uLocal_1678 = unk_0x96A32328480B485C(joaat("DEFAULT_SCRIPTED_CAMERA"), uLocal_1685, uLocal_1688, 42.203197f, 0, 2);
					unk_0xB56F35D8A770F80F(uLocal_1678, uLocal_1677, 5000, 1, 1);
					unk_0x2A09425009DAD0F5(uLocal_1677, "HAND_SHAKE", 0.3f);
				}
		...
		case 4:
			...
			unk_0xF293D66D4452C854(iLocal_1062, "Lester", 2, joaat("IG_LesterCrest"), 0);
		...
		case 6:
			...
			if (!unk_0xFC8BFE4B41177C22(iLocal_1062))
				if (unk_0x24CAD023099769B1("Lester", 0))
					if (unk_0xFC8BFE4B41177C22(unk_0x4240B5D04F91480C("Lester", 0)))
						iLocal_1062 = unk_0xBD545F8729E9F413(unk_0x4240B5D04F91480C("Lester", 0));
		
			if (!unk_0xFC8BFE4B41177C22(uLocal_1063))
				if (unk_0x24CAD023099769B1("WalkingStick_Lester", 0))
					if (unk_0xFC8BFE4B41177C22(unk_0x4240B5D04F91480C("WalkingStick_Lester", 0)))
						uLocal_1063 = unk_0x4240B5D04F91480C("WalkingStick_Lester", 0);
			...
			if (unk_0xFC8BFE4B41177C22(unk_0x4240B5D04F91480C("Lester", 0)))
			{
				...
				{
					if (unk_0xFC8BFE4B41177C22(iLocal_1062) && !unk_0x4FAFF4BCB7633475(iLocal_1062))
					{
						unk_0xB2BD5837A8D3CEDA(iLocal_1062, -1509.458f, -948.195f, 7.75f, 1, 0, 0, 1);
						unk_0x5C96CEA06531AB03(iLocal_1062, -11f);
						unk_0x10425721983AE158(iLocal_1062, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
						unk_0xD8ED11B32DF72E0B(iLocal_1062, 0, 0);
					}
				}
			}
			...
			if (unk_0xFC8BFE4B41177C22(unk_0x4240B5D04F91480C("Lester", 0)))
				if (unk_0xD8FC13DA1BA1DBA2("WalkingStick_Lester", 0))
					if (unk_0xFC8BFE4B41177C22(iLocal_1062) && !unk_0x4FAFF4BCB7633475(iLocal_1062))
						unk_0x4D306DD94DD6FDBA(uLocal_1063, iLocal_1062, unk_0x72F7E39FB49FC0BA(iLocal_1062, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
			...
			if (unk_0xC9BA6D804FA4FAAA() && !unk_0xFD216000DC314A92())
			{
				...
				if (!unk_0x4FAFF4BCB7633475(iLocal_1062))
				{
					unk_0xD0F1DB0E50B367AD(iLocal_1062, 0, 0, 0, 0, 0, 0, 0, 0);
					unk_0x9FF00EA9A61211D2(iLocal_1062, 1);
				}
...
{
	if (!unk_0xFC8BFE4B41177C22(uLocal_1694))
		uLocal_1694 = unk_0x8366ABB82B1ABC59(-1510.1029f, -947.7194f, 8.2332f, 5f, joaat("prop_bench_08"), 1, 0, 1);
				...
				if (unk_0xFC8BFE4B41177C22(unk))
				{
					if (unk_0xD9F5E1FEFD1329E4(unk, 0))
					{
						if (unk != uLocal_1324[0] && unk != uLocal_1324[1] && unk != uLocal_1324[2])
						{
							...
							unk_0xEE0BCDB1B5E36BCB(uLocal_1324[iLocal_1220 + 1], 1, 0);
							unk_0xE8EF17ECD68C900D(uLocal_1324[iLocal_1220 + 1], 0);
...
void func_461() // Position - 0x1A364
{
	...
	switch (iLocal_1210)
	{
		case 0:
			...
			{
				if (!unk_0x1C2F771CDC87A3A5(uLocal_1695[0], 0) && !unk_0x1C2F771CDC87A3A5(uLocal_1695[1], 0))
				{
					unk_0xE67051907958B5EB(uLocal_1695[0], uLocal_1695[1], -1, 0, 2);
					unk_0xE67051907958B5EB(uLocal_1695[1], uLocal_1695[0], -1, 0, 2);
				}
			
				if (unk_0xFC8BFE4B41177C22(uLocal_1695[1]) && unk_0xFC8BFE4B41177C22(uLocal_1695.f_4) && !unk_0x4FAFF4BCB7633475(uLocal_1695[1]) && unk_0xD9F5E1FEFD1329E4(uLocal_1695.f_4, 0))
				{
					unk_0x974022927CB47E68(uLocal_1695[1]);
					unk_0xEBA229B2E0BB05E0(uLocal_1695[1], uLocal_1695.f_4, 20000, 2, 1f, 1, 0);
				}
		...
		case 1:
			if (!bLocal_1178)
			{
				if (func_58(&uLocal_1352))
				{
					...
					{
						if (unk_0xFC8BFE4B41177C22(uLocal_1695[0]) && unk_0xFC8BFE4B41177C22(uLocal_1695.f_4) && !unk_0x4FAFF4BCB7633475(uLocal_1695[0]) && unk_0xD9F5E1FEFD1329E4(uLocal_1695.f_4, 0))
						{
							if (unk_0x9B5C1660CCDF7189(uLocal_1695[0], joaat("SCRIPT_TASK_ENTER_VEHICLE")) != 1)
							{
								unk_0x974022927CB47E68(uLocal_1695[0]);
								unk_0xEBA229B2E0BB05E0(uLocal_1695[0], uLocal_1695.f_4, 20000, 1, 1f, 1, 0);
								bLocal_1178 = true;
							}
						}
					}
			...
			if (!unk_0x4FAFF4BCB7633475(uLocal_1695[0]) && !unk_0x4FAFF4BCB7633475(uLocal_1695[1]))
			{
				if (unk_0xCECDBB848D53DEB2(uLocal_1695[0], uLocal_1695.f_4, 0) && unk_0xCECDBB848D53DEB2(uLocal_1695[1], uLocal_1695.f_4, 0))
				{
					if (!unk_0x1C2F771CDC87A3A5(uLocal_1695.f_3, 0) && !unk_0x1C2F771CDC87A3A5(uLocal_1695.f_4, 0))
					{
						unk_0x84B06A81C98DA4B8(uLocal_1695.f_3);
						func_56(&uLocal_1352);
					}
		...
		case 2:
			if (func_58(&uLocal_1352))
			{
				if (func_52(&uLocal_1352) > 3f)
				{
					if (!unk_0x4FAFF4BCB7633475(uLocal_1695.f_3) && unk_0xD9F5E1FEFD1329E4(uLocal_1695.f_4, 0))
					{
						unk_0x43E9B2BD3668B432(uLocal_1695.f_3, uLocal_1695.f_4, "OJAS_HotelTaxi01", 786485, 0, 16, -1, 10f, 0, 1073741824);
						iLocal_1210 = iLocal_1210 + 1;
					}
				}
			}
		...
		case 3:
			if (!unk_0x1C2F771CDC87A3A5(uLocal_1695.f_3, 0) && !unk_0x1C2F771CDC87A3A5(uLocal_1695.f_4, 0))
			{
				if (!unk_0x8DC9348C726B1575(uLocal_1695.f_4) || bLocal_1181)
				{
					unk_0x7C8E9DE09D4AD3FF(uLocal_1695.f_3, uLocal_1695.f_4, 10f, 786603);
					iLocal_1210 = iLocal_1210 + 1;
				}
			}
			break;
		...
		case 4:
			if (bLocal_1181)
			{
				if (!unk_0x4FAFF4BCB7633475(uLocal_1058[0]))
					num = uLocal_1058[0];
				else
					num = func_31(25f);
...
{
	if (unk_0xFC8BFE4B41177C22(uLocal_1695.f_3) && !unk_0x1C2F771CDC87A3A5(uLocal_1695.f_3, 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		unk_0xD844F5E50DAB6FF7(uLocal_1695.f_3, unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);

	if (unk_0xFC8BFE4B41177C22(uLocal_1695[0]) && !unk_0x1C2F771CDC87A3A5(uLocal_1695[0], 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
	{
		unk_0xD844F5E50DAB6FF7(uLocal_1695[0], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);
		unk_0x1CA08719184AFC6F(uLocal_1695[0], 2, 0);
	}

	if (unk_0xFC8BFE4B41177C22(uLocal_1695[1]) && !unk_0x1C2F771CDC87A3A5(uLocal_1695[1], 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
	{
		unk_0xD844F5E50DAB6FF7(uLocal_1695[1], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);
		unk_0x1CA08719184AFC6F(uLocal_1695[1], 2, 0);
	}

	if (unk_0xFC8BFE4B41177C22(uLocal_1695.f_8[0]) && !unk_0x1C2F771CDC87A3A5(uLocal_1695.f_8[0], 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		unk_0xD844F5E50DAB6FF7(uLocal_1695.f_8[0], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);

	if (unk_0xFC8BFE4B41177C22(uLocal_1695.f_8[1]) && !unk_0x1C2F771CDC87A3A5(uLocal_1695.f_8[1], 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		unk_0xD844F5E50DAB6FF7(uLocal_1695.f_8[1], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);

	if (unk_0xFC8BFE4B41177C22(uLocal_1695.f_5[0]) && !unk_0x1C2F771CDC87A3A5(uLocal_1695.f_5[0], 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		unk_0xD844F5E50DAB6FF7(uLocal_1695.f_5[0], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);

	if (unk_0xFC8BFE4B41177C22(uLocal_1695.f_5[1]) && !unk_0x1C2F771CDC87A3A5(uLocal_1695.f_5[1], 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		unk_0xD844F5E50DAB6FF7(uLocal_1695.f_5[1], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);
...
{
	if (!unk_0x1C2F771CDC87A3A5(uLocal_1695.f_3, 0))
		if (unk_0xA6534E6C7AE314D6(uLocal_1695.f_3))
			if (unk_0xC1089D3918F03D33(uLocal_1695.f_3) == unk_0x4A8C381C258A124D())
				return true;

	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x1C2F771CDC87A3A5(uLocal_1695.f_4, 0))
		if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), uLocal_1695.f_4, 0))
			return true;
	...
	if (func_529(uParam0))
	{
		...
		if (func_528(uParam0))
		{
			...
			if (unk_0xFC8BFE4B41177C22(unk))
			{
				...
				else if (!func_496(unk, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && unk_0x1B79E937E91F40C3(unk_0x1AF90EB93E0012D6(), "startup_positioning"))
				{
					num = func_495(unk);
...
{
	if (!unk_0xFC8BFE4B41177C22(uParam0) || !unk_0xD9F5E1FEFD1329E4(uParam0, 0) || func_317(uParam0, 0, false) || func_317(uParam0, 1, false) || func_317(uParam0, 2, false) || func_302(uParam0) != _CHAR_NULL || func_486(uParam0) || func_485(uParam0) || func_484(uParam0) || func_483(uParam0) || !func_471(unk_0x4B423FAA24E8ABF0(uParam0)))
	{
		func_485(uParam0);
		func_485(uParam0);
...
BOOL func_472(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1B255
{
	...
	{
		if (func_477() || unk_0x761778199FE1211C() || func_476())
		{
		}
		else if (!func_479())
		{
...
BOOL func_496(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2090F
{
	...
	switch (num)
	{
		...
		case joaat("cuban800"):
			...
			{
				if (func_498(uParam0, unk[i], true) && func_497(unk_0xD1A6A821F5AC81DB(unk[i], 1), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
...
void func_500(eCharacter echParam0, int iParam1) // Position - 0x20C75
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(Global_98012[i]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x4B423FAA24E8ABF0(Global_98012[i]) == func_304(echParam0, iParam1))
				{
...
void func_501(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x20D13
{
	...
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(num + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(num2 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			for (i = 1; i <= 9; i = i + 1)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(i));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			for (j = 1; j <= 6; j = j + 1)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(j));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			for (k = 1; k <= 11; k = k + 1)
			{
				if (k != 9 && k != 10)
				{
					...
					{
						unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(k));
					}
				}
			}
		}
		else if (uParam1->f_66 == -1035489563)
		{
			for (l = 1; l <= 2; l = l + 1)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(l));
				}
			}
		}
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(4));
			}
		}
		...
		{
			unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			for (m = 1; m <= 2; m = m + 1)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_307(m));
				}
			}
		}
		...
		if (func_502() && unk_0x00C6FDED3EB75117(uParam1->f_66) && unk_0x8EC15ED9ECD1E9D0(uParam0) && !unk_0x2E6A27037F1DC473(uParam0, joaat("avenger")))
...
int func_507(var uParam0, var uParam1, var uParam2) // Position - 0x21502
{
	...
	if (func_512(unk_0x4B423FAA24E8ABF0(*uParam0), 1) && unk_0x94C9CD3D66808551(*uParam0, 24) != func_510(*uParam0, uParam1->[38] - 1))
		unk_0x8450270DC5896D39(*uParam0, 24, func_510(*uParam0, uParam1->[38] - 1), 0);
...
int func_511(var uParam0, int iParam1) // Position - 0x218F8
{
	...
	for (i = unk_0x5B59C12A02157D00(uParam0, iParam1) - 1; i >= 0 && func_513(uParam0, iParam1, i); i = i - 1)
	{
	}
...
{
	if (!func_514() && unk_0xAF82FE1B3E949337(uParam0, iParam1, iParam2))
		return true;
...
BOOL func_520(var uParam0) // Position - 0x21EAA
{
	...
	if (func_522(unk_0x259BE71D8A81D4FA()) == 3)
		if (unk_0xFC8BFE4B41177C22(uParam0) && unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_541() // Position - 0x22771
{
	...
	if (unk_0xFC8BFE4B41177C22(Global_97178.f_28[0]))
	{
		...
		unk_0xB3B56385ECA230B4(&Global_97178.f_28[0]);
	}

	unk_0xD7B6A43ACC36D868(uLocal_1132, 0);
	...
	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
	{
		func_543(unk_0x4A8C381C258A124D(), 1);
		unk_0x96A0632EBDD87FA3(unk_0x4A8C381C258A124D(), 0, -1, 0);
	}

	unk_0x425BBE19F25A57AB(1f);
	unk_0x93586F94C370857F();
	unk_0xA1F44380A2D59F2B(iLocal_1331, 0);
	unk_0xA1F44380A2D59F2B(iLocal_1332, 0);
	func_542();
