...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8B7B
{
	...
	bParam4;
	statName = Global_2805029[empsParam0 /*3*/][func_170(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x8DCF
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0 /*3*/][func_170(iParam1)];
...
BOOL func_320(int iParam0, int iParam1) // Position - 0xFECD
{
	...
	statHash = Global_2848282[iParam0 /*3*/][func_170(iParam1)];
