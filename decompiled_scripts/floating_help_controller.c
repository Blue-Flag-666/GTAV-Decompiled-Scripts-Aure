				...
				if (Global_112300[i /*28*/].f_21 != -1)
				{
					if (!IS_BIT_SET(Global_112300[i /*28*/].f_27, 0))
					{
						...
						if (HUD::IS_FLOATING_HELP_TEXT_ON_SCREEN(hudIndex))
							MISC::SET_BIT(&(Global_112300[i /*28*/].f_27), 0);
					}
				}
			
				if (Global_112300[i /*28*/].f_24.f_2 != 9999f)
					if (Global_112300[i /*28*/].f_23 != 0)
						if (!ENTITY::IS_ENTITY_DEAD(Global_112300[i /*28*/].f_23, false))
							if (!IS_BIT_SET(Global_112300[i /*28*/].f_27, 3))
								HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(hudIndex, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112300[i /*28*/].f_23, Global_112300[i /*28*/].f_24));
							else
								HUD::SET_FLOATING_HELP_TEXT_TO_ENTITY(hudIndex, Global_112300[i /*28*/].f_23, Global_112300[i /*28*/].f_24, Global_112300[i /*28*/].f_24.f_1);
					else if (Global_112300[i /*28*/].f_24 != 0f || Global_112300[i /*28*/].f_24.f_1 != 0f || Global_112300[i /*28*/].f_24.f_2 != 0f)
						HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(hudIndex, Global_112300[i /*28*/].f_24);
				else
					HUD::SET_FLOATING_HELP_TEXT_SCREEN_POSITION(hudIndex, Global_112300[i /*28*/].f_24, Global_112300[i /*28*/].f_24.f_1);
			}
			else if (MISC::GET_GAME_TIMER() - Global_112300[i /*28*/].f_22 > 1000)
			{
				func_2(i);
			}
		}
