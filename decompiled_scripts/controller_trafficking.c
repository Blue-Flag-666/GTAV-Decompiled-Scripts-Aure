	...
	while (true)
	{
		...
		if (func_178())
		{
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
				fLocal_31 = SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_32);
			...
			if (iLocal_47 > 3)
			{
				if (fLocal_31 < 600f)
				{
					if (func_28(0) == false && unk_0x1DD05E817C89C737() - uLocal_81 > 2000)
					{
...
BOOL func_2(int iParam0) // Position - 0x2A4
{
	...
	return unk_0xC450B06E5AAA0985(Global_32543[num /*23*/].f_19);
}
...
void func_31(var uParam0) // Position - 0x14D4
{
	...
	switch (iLocal_53)
	{
		...
		case 3:
			...
			{
				unk_0x60040CDD28AA1BC3(uLocal_55, 4f, 0, 0, 0, 0, 0, 0, 0);
			
				if (unk_0xFC8BFE4B41177C22(uLocal_54))
					unk_0x8C1F7D7A31B2A38E(&uLocal_54);
			
				uLocal_54 = unk_0x5779387E956077A6(func_167(), uLocal_55, fLocal_58, 1, 1, 0);
				unk_0x4DC72C4B884A6C59(uLocal_54, 0);
				unk_0x55098D9E9AD58806(func_167());
			
				if (unk_0xFC8BFE4B41177C22(uLocal_54))
				{
					if (unk_0x579FA5568DE0C2A0(uLocal_54, 1))
						unk_0xD772F6AA66750D2B(uLocal_54, 1, 1);
				
					if (unk_0x579FA5568DE0C2A0(uLocal_54, 2))
						unk_0xD772F6AA66750D2B(uLocal_54, 2, 0);
				
					if (unk_0x579FA5568DE0C2A0(uLocal_54, 3))
						unk_0xD772F6AA66750D2B(uLocal_54, 3, 0);
				
					unk_0xD133EF7430EDCD09(uLocal_54, 0, 0);
				}
		...
		case 4:
			...
			if (!flag && !*uParam0)
			{
				...
				if (!bLocal_59)
				{
					if (unk_0x7F420695E3F776FB(uLocal_28, 0))
					{
						unk = unk_0xCDA725BC2F170795(uLocal_28);
			...
			if (*uParam0)
				if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x1C2F771CDC87A3A5(uLocal_54, 0))
					unk_0x73CAFD2038E812B3(unk_0x4A8C381C258A124D(), uLocal_54, -1);
		
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x1C2F771CDC87A3A5(uLocal_54, 0))
				if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), uLocal_54, 1))
					func_165();
		
			if (!unk_0x1C2F771CDC87A3A5(uLocal_54, 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
			{
				if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
				{
					...
					if (unk2 == uLocal_54)
					{
						if (SYSTEM::VDIST2(uLocal_55, unk_0xD1A6A821F5AC81DB(uLocal_28, 1)) < 100f)
						{
							unk_0x97A5024CE91641F1("Traffick_Ground");
						
							if (unk_0xFC8BFE4B41177C22(iLocal_29) && !unk_0x1C2F771CDC87A3A5(iLocal_29, 0))
								if (unk_0x4B423FAA24E8ABF0(iLocal_29) != joaat("dune") && unk_0x4B423FAA24E8ABF0(iLocal_29) != joaat("cuban800"))
									...
									unk_0xE3A0299C9DEE59C8(iLocal_29);
		...
		case 6:
			if (unk_0xA6E4F7A73ABC4A76("Traffick_Ground"))
			{
				...
				if (num == 1)
				{
					...
					unk_0xEE0BCDB1B5E36BCB(uLocal_54, 1, 0);
					unk_0x68298CA6191CDFDB(&uLocal_54);
		...
		case 7:
			if (!unk_0xF40767E41852FB72(iLocal_30))
			{
				iLocal_53 = 9;
...
void func_87(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3A31
{
	...
	*uParam0 = _GET_CURRENT_PLAYER_CHARACTER();
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		...
		func_104(unk_0x4A8C381C258A124D());
		func_97(unk_0x4A8C381C258A124D(), false);
...
BOOL func_93(int iParam0, int iParam1) // Position - 0x4AFA
{
	...
	unk = Global_2848282[iParam0 /*3*/][func_91(iParam1)];
...
void func_98(var uParam0, var uParam1) // Position - 0x53BC
{
	...
	if (!unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		for (i = 0; i <= 44 - 1; i = i + 1)
		{
			...
			if (num != 0)
			{
				num2 = unk_0xBCEDAE6CA2B2046E(uParam0, func_103(i));
				num2.f_1 = 0;
				num2.f_2 = 0;
				num2.f_3 = 0;
				num2.f_4 = 0;
		...
		{
			if (unk_0xA40B513DA7201333(l, &unk5) && !func_100(unk5.f_1) && num4 < 51)
			{
...
BOOL func_109(var uParam0) // Position - 0x7562
{
	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		if (func_135())
		{
			*uParam0 = func_115(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), 6, -1, false, true, -1);
...
int func_115(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x79E2
{
	...
	for (i = 0; i <= 59; i = i + 1)
	{
		if (iParam3 == 6 || iParam3 == func_134(i))
		{
			...
			{
				num = unk_0xED977E2AE2CB16EE(uParam0, func_116(i, false), 1);
...
{
	return func_132(unk_0x259BE71D8A81D4FA());
}
...
{
	if (!unk_0xFC8BFE4B41177C22(iParam0) || !unk_0xD9F5E1FEFD1329E4(iParam0, 0) || func_20(iParam0, 0, false) || func_20(iParam0, 1, false) || func_20(iParam0, 2, false) || func_9(iParam0) != 145 || func_155(iParam0) || func_154(iParam0) || func_153(iParam0) || func_152(iParam0) || !func_142(unk_0x4B423FAA24E8ABF0(iParam0)))
	{
		func_154(iParam0);
		func_154(iParam0);
...
void func_166() // Position - 0xF802
{
	...
	if (!unk_0xFC8BFE4B41177C22(iLocal_29))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		{
			if (SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_32) < 2500f)
			{
				iLocal_29 = unk_0xDC8D5832207C2EAD();
			
				if (unk_0xFC8BFE4B41177C22(iLocal_29))
				{
					num = unk_0x4B423FAA24E8ABF0(iLocal_29);
					num == joaat("dune");
				}
			}
		}
	...
	switch (iLocal_47)
	{
		...
		case 3:
			...
			if (unk_0x6252BC0DD8A320DB(joaat("cuban800")))
			{
				...
				{
					unk_0x60040CDD28AA1BC3(uLocal_50, 8f, 0, 0, 0, 0, 0, 0, 0);
					uLocal_48 = unk_0x5779387E956077A6(joaat("cuban800"), uLocal_50, 25.29f, 1, 1, 0);
					unk_0x55098D9E9AD58806(joaat("cuban800"));
					unk_0x20DD46D27530FAC7(uLocal_48, 2);
		...
		case 4:
			if (unk_0xFC8BFE4B41177C22(uLocal_48))
			{
				if (unk_0x1C2F771CDC87A3A5(uLocal_48, 0) || unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
				{
					iLocal_47 = 9;
					return;
				}
			...
			if (func_28(9))
			{
				if (unk_0x486FF5D06E9659F1(joaat("traffick_ground")) == 1)
				{
					...
					{
						unk_0x0B74F181ADFC39BF(uLocal_48, 2);
						return;
					}
				}
			}
			...
			{
				if (!unk_0x1C2F771CDC87A3A5(uLocal_48, 0))
					unk_0x0B74F181ADFC39BF(uLocal_48, 1);
			}
			...
			if (*uParam0)
				unk_0x73CAFD2038E812B3(uLocal_28, uLocal_48, -1);
		
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x1C2F771CDC87A3A5(uLocal_48, 0))
				if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), uLocal_48, 1))
					func_165();
			...
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
			{
				if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
				{
					...
					if (unk2 == uLocal_48)
					{
						...
						if (unk_0xFC8BFE4B41177C22(iLocal_29) && !unk_0x1C2F771CDC87A3A5(iLocal_29, 0))
							if (unk_0x4B423FAA24E8ABF0(iLocal_29) != joaat("dune") && unk_0x4B423FAA24E8ABF0(iLocal_29) != joaat("cuban800"))
								if (!unk_0x5105BE70DEF1F5FB(iLocal_29, 2137.1204f, 4799.97f, 39.678535f, 2116.64f, 4790.417f, 45.452946f, 25f, 0, 1, 0))
									func_138(iLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, false);
							else if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
								unk_0xE3A0299C9DEE59C8(iLocal_29);
...
BOOL func_178() // Position - 0x10227
{
	...
	uLocal_28 = unk_0x4A8C381C258A124D();
	unk_0x1C2F771CDC87A3A5(uLocal_28, 0);
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_187() || Global_32166 || func_181() || func_180(8, -1) || func_179() || func_135() || func_186() || func_185() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_187() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_180(8, -1) || func_185() || func_184() || Global_113648.f_7690.f_919[character] == 5)
							return false;
						break;
...
void func_192() // Position - 0x10C4B
{
	if (!bLocal_80)
	{
		iLocal_79 = unk_0xA7B0B03284E7503C({ 40.073f, 4788.5586f, 2157.109f } - { 25f, 25f, 25f }, { 40.073f, 4788.5586f, 2157.109f } + { 25f, 25f, 25f }, 0, 1, 1, 1);
		bLocal_80 = true;
	}
...
{
	if (iLocal_79 != 0)
		unk_0xD7B6A43ACC36D868(iLocal_79, 0);
...
void func_197() // Position - 0x10DEB
{
	...
	for (i = 0; i < 5; i = i + 1)
	{
		if (unk_0xB0E14182FAD64944(uLocal_67[i]))
			unk_0xDDFB0941A19702BE(uLocal_67[i]);
	
		if (unk_0xFC8BFE4B41177C22(uLocal_61[i]))
			unk_0x51C8BEA2005931AB(&uLocal_61[i]);
	}
